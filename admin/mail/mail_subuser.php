<?php
  ...
  $mail->AddEmbeddedImage("main.jpg", "logo", "main.jpg");
  $mail->AddEmbeddedImage("logo_dark.png", "dark", "logo_dark.png");
  $mail->Body = "
...
<body class='body' style='padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#f4f4f4; -webkit-text-size-adjust:none;'>
                            ...
                            <tr>
                              <th class='column-top' width='300' style='font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;'>
                                <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                  ...
                                  <tr>
                                    <td class='h5' style='padding-bottom: 20px; color:#000000; font-family:Montserrat, Arial, sans-serif; font-size:14px; line-height:18px; text-align:left; font-weight:bold; text-transform:uppercase;'><multiline> Dear ".$admin_firstname." ".$admin_lastname.",<br /></multiline></td>
                                  </tr>
                                </table>
                              </th>
                              ...
                              <th class='column-top' style='font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;'>
                                <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                  <tr>
                                    <td class='text' style='padding-bottom: 20px; color:#000000; font-family:Arial, sans-serif; font-size:15px; line-height:30px; text-align:left; min-width:auto !important;'><multiline>Here are your login details.<br /> Username : ".$admin_username."<br /> Password : ".$admin_password."<br /></multiline></td>
                                  </tr>
                                  <tr>
  ...
  $mail->AddAddress($admin_email, "Reseller Online");
  $mail->Send();
  if($mail) 
  {
    echo "  <script language='javascript'> window.location='../subuser/'; </script> ";
  }
