              ...
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    ...
                    <strong> Update Price (Fabric Brand) </strong>
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                      <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabricbrand_pricecopy_code.php" method="post">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body"> 
                <!--begin: Datatable -->
                <?
              $strSQL1 = " SELECT DISTINCT fabricbrand_name FROM admin_fabricbrand WHERE fabricbrand_status = 'T' ORDER BY id ASC ";
			  ...
			  ?>
                <table width="100%">
                  ...
                  <tbody>
                  <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabricbrand_price_code.php" method="post">
                    <input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_id" id="reseller_id" value="<?=$id?>" required>
                    <? while($objResult1 = mysql_fetch_array($objQuery1)) { ?>
                    <tr>
                      <td style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><?=$objResult1["fabricbrand_name"]?></td>
                      <?
					  $fabricbrand_name_now = $objResult1["fabricbrand_name"];
              $strSQL2 = " SELECT * FROM admin_fabricbrand WHERE fabricbrand_status = 'T' AND fabricbrand_name = '$fabricbrand_name_now' ORDER BY id ASC ";
			  ...
			  ?>
                      ...
                      <td style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="id_<?=$objResult2["id"]?>" id="id_<?=$objResult2["id"]?>" value="<?=$objResult2["id"]?>" required>
                        <? if ($id == '1') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_1"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '2') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_2"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '3') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_3"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '4') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_4"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '5') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_5"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '6') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_6"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '7') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_7"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '8') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_8"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '9') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_9"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } if ($id == '10') { ?>
                        <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["fabricbrand_10"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                        <? } ?></td>
                      <? } ?>
                    </tr>
                    <? } ?>
