              ...
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    ...
                    <strong> Other Pricing Parameters </strong>
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                      <form class="m-form m-form--fit m-form--label-align-right" action="../include/parameter_pricecopy_code.php" method="post">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body"> 
                <!--begin: Datatable -->
                <?
              $strSQL1 = " SELECT * FROM admin_parameter WHERE parameter_status = 'T' ORDER BY id ASC ";
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable">
                  <thead>
                    <tr>
                      ...
                      <th style="font-family: 'Roboto', sans-serif;"> Parameter </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Price </th>
                      <th style="font-family: 'Roboto', sans-serif;"> </th>
                    </tr>
                  </thead>
                  <tbody>
                    <? while($objResult1 = mysql_fetch_array($objQuery1)) { ?>
                  <form class="m-form m-form--fit m-form--label-align-right" action="../include/parameter_price_code.php" method="post">
                    <tr>
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["parameter_category"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["parameter_name"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_id" id="reseller_id" value="<?=$id?>" required>
                        <input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="id" id="id" value="<?=$objResult1["id"]?>" required>
                        <? if ($id == "1") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_1"]?>" placeholder="Price">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "2") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_2"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "3") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_3"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "4") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_4"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "5") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_5"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "6") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_6"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "7") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_7"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "8") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_8"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "9") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_9"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } else if ($id == "10") { ?>
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price" id="price" value="<?=$objResult1["parameter_10"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <span class="m-input-icon__icon m-input-icon__icon--right"> <span> <i>%</i> </span> </span> </div>
                        <? } ?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><button type="submit" class="btn btn-primary" style="font-family: 'Roboto', sans-serif;"> Update </button></td>
                    </tr>
                  </form>
                  <? } ?>
                    </tbody>
