              ...
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    ...
                    <strong> Additional Options Price </strong>
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                      <form class="m-form m-form--fit m-form--label-align-right" action="../include/extraoption_pricecopy_code.php" method="post">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body"> 
                <!--begin: Datatable -->
                <form class="m-form m-form--fit m-form--label-align-right" action="../include/extraoption_price_code.php" method="post">
                  <input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_id" id="reseller_id" value="<?=$id?>" required>
                  <?
              $strSQL1 = " SELECT * FROM admin_extraoptions WHERE extra_type = 'jacket' AND extra_status = 'T' ORDER BY id ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                  <table width="100%">
                    <thead>
                      <tr style="height:50px;">
                        <th width="80%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"> ADDITIONAL OPTIONS PRICE </th>
                        <th width="20%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"> PER UNIT </th>
                      </tr>
                      <tr style="height:30px;">
                        <th width="100%" colspan="2" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><strong> EXTRA OPTIONS PRICE - JACKET </strong></th>
                      </tr>
                    </thead>
                    <tbody>
                      <? while($objResult1 = mysql_fetch_array($objQuery1)) { ?>
                      <tr style="height:30px;">
                        <td width="80%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><?=$objResult1["extra_name"]?></td>
                        <td width="20%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="id_<?=$objResult1["id"]?>" id="id_<?=$objResult1["id"]?>" value="<?=$objResult1["id"]?>" required>
                          <? if ($id == '1') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_1"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '2') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_2"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '3') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_3"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '4') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_4"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '5') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_5"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '6') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_6"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '7') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_7"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '8') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_8"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '9') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_9"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '10') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult1["id"]?>" id="price_<?=$objResult1["id"]?>" value="<?=$objResult1["extra_10"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } ?></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  ...
                  <?
              $strSQL2 = " SELECT * FROM admin_extraoptions WHERE extra_type = 'overcoat' AND extra_status = 'T' ORDER BY id ASC ";
			  $objQuery2 = mysql_query($strSQL2) or die ("Error Query [".$strSQL2."]");
			  ?>
                  <table width="100%">
                    <thead>
                      <tr style="height:30px;">
                        <th width="100%" colspan="2" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><strong> EXTRA OPTIONS PRICE - OVERCOAT </strong></th>
                      </tr>
                    </thead>
                    <tbody>
                      <? while($objResult2 = mysql_fetch_array($objQuery2)) { ?>
                      <tr style="height:30px;">
                        <td width="80%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><?=$objResult2["extra_name"]?></td>
                        <td width="20%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="id_<?=$objResult2["id"]?>" id="id_<?=$objResult2["id"]?>" value="<?=$objResult2["id"]?>" required>
                          <? if ($id == '1') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_1"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '2') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_2"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '3') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_3"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '4') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_4"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '5') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_5"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '6') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_6"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '7') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_7"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '8') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_8"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '9') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_9"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '10') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult2["id"]?>" id="price_<?=$objResult2["id"]?>" value="<?=$objResult2["extra_10"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } ?></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  ...
                  <?
              $strSQL3 = " SELECT * FROM admin_extraoptions WHERE extra_type = 'shirt' AND extra_status = 'T' ORDER BY id ASC ";
			  $objQuery3 = mysql_query($strSQL3) or die ("Error Query [".$strSQL3."]");
			  ?>
                  <table width="100%">
                    <thead>
                      <tr style="height:30px;">
                        <th width="100%" colspan="2" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><strong> EXTRA OPTIONS PRICE - SHIRT </strong></th>
                      </tr>
                    </thead>
                    <tbody>
                      <? while($objResult3 = mysql_fetch_array($objQuery3)) { ?>
                      <tr style="height:30px;">
                        <td width="80%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><?=$objResult3["extra_name"]?></td>
                        <td width="20%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="id_<?=$objResult3["id"]?>" id="id_<?=$objResult3["id"]?>" value="<?=$objResult3["id"]?>" required>
                          <? if ($id == '1') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_1"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '2') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_2"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '3') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_3"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '4') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_4"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '5') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_5"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '6') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_6"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '7') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_7"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '8') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_8"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '9') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_9"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '10') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult3["id"]?>" id="price_<?=$objResult3["id"]?>" value="<?=$objResult3["extra_10"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } ?></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  ...
                  <?
              $strSQL4 = " SELECT * FROM admin_extraoptions WHERE extra_type = 'pants' AND extra_status = 'T' ORDER BY id ASC ";
			  $objQuery4 = mysql_query($strSQL4) or die ("Error Query [".$strSQL4."]");
			  ?>
                  <table width="100%">
                    <thead>
                      <tr style="height:30px;">
                        <th width="100%" colspan="2" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><strong> EXTRA OPTIONS PRICE - PANTS </strong></th>
                      </tr>
                    </thead>
                    <tbody>
                      <? while($objResult4 = mysql_fetch_array($objQuery4)) { ?>
                      <tr style="height:30px;">
                        <td width="80%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><?=$objResult4["extra_name"]?></td>
                        <td width="20%" style="border: 1px solid #c5c5c5; font-family: 'Roboto', sans-serif;"><input type="hidden" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="id_<?=$objResult4["id"]?>" id="id_<?=$objResult4["id"]?>" value="<?=$objResult4["id"]?>" required>
                          <? if ($id == '1') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_1"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '2') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_2"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '3') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_3"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '4') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_4"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '5') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_5"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '6') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_6"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '7') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_7"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '8') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_8"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '9') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_9"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } if ($id == '10') { ?>
                          <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif; width:100px;" name="price_<?=$objResult4["id"]?>" id="price_<?=$objResult4["id"]?>" value="<?=$objResult4["extra_10"]?>" placeholder="Price" OnKeyPress="return chkNumber(this)">
                          <? } ?></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  ...
                  <table width="100%">
                    <tr>
                      <td width="100%" colspan="2" style="font-family: 'Roboto', sans-serif;" align="right"><br>
