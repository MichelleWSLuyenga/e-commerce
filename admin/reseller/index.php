            ...
            <div class="m-menu__submenu "> <span class="m-menu__arrow"></span>
              <ul class="m-menu__subnav">
                ...
                <li class="m-menu__item " aria-haspopup="true"> <a  href="../fabrics/" class="m-menu__link "> <i class="m-menu__link-bullet m-menu__link-bullet--dot"> <span></span> </i> <span class="m-menu__link-text" style="font-family: 'Roboto', sans-serif;"> Add Fabrics </span> </a> </li>
								<li class="m-menu__item " aria-haspopup="true"> <a  href="../fabrics/addcat.php" class="m-menu__link "> <i class="m-menu__link-bullet m-menu__link-bullet--dot"> <span></span> </i> <span class="m-menu__link-text" style="font-family: 'Roboto', sans-serif;"> Add Option </span> </a> </li>
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/reseller_add_code.php" method="post">
                <div class="m-portlet__body">
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_company" id="reseller_company" placeholder="Reseller Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> First Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_firstname" id="reseller_firstname" placeholder="First Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Last Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_lastname" id="reseller_lastname" placeholder="Last Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Email </label>
                    <input type="email" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_email" id="reseller_email" placeholder="Email" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Phone </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_phone" id="reseller_phone" placeholder="Phone" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Username </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_username" id="reseller_username" placeholder="Username" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Password (8)</label>
                    <input type="password" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_password" id="reseller_password" maxlength="8" placeholder="Password" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Address </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_address" id="reseller_address" placeholder="Address" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> City </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_city" id="reseller_city" placeholder="City" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> State </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_state" id="reseller_state" placeholder="State" required>
                  </div>
                  <div class="form-group m-form__group">
			  ...
			  ?>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_zipcode" id="reseller_zipcode" placeholder="Zipcode" required>
                  </div>
                  <div class="form-group m-form__group">
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <label style="font-family: 'Roboto', sans-serif;">
                      <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_order_font" id="reseller_order_font" placeholder="Example: VG" required>
                    </label>
                    <label style="font-family: 'Roboto', sans-serif;"> - </label>
                    <label style="font-family: 'Roboto', sans-serif;">
                      <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_order_number" id="reseller_order_number" placeholder="Example: 101" maxlength="6" OnKeyPress="return chkNumber(this)" required>
                    </label>
                    <label style="font-family: 'Roboto', sans-serif;"> Example: VG-101 </label>
                    <br>
