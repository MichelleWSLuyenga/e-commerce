      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/reseller_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Reseller Accout Type </label>
                    <input type="hidden" name="id" id="id" value="<?=$row1['id'];?>" required>
                    <input type="hidden" name="fabricbrand_admin" id="fabricbrand_admin" value="<?=$row_user['id'];?>" required>
                    <br>
                    <label class="m-radio">
                      <? if ($row1['reseller_type'] == 'Admin') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_type" id="reseller_type" value="Admin" checked>
                      <? } else if ($row1['reseller_type'] != 'Admin') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_type" id="reseller_type" value="Admin">
                      <? } ?>
                      Admin <span></span> </label>
                    <label class="m-radio">
                      <? if ($row1['reseller_type'] == 'Sub-admin') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_type" id="reseller_type" value="Sub-admin" checked>
                      <? } else if ($row1['reseller_type'] != 'Sub-admin') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_type" id="reseller_type" value="Sub-admin">
                      <? } ?>
                      Sub-admin <span></span> </label>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Reseller Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_company" id="reseller_company" value="<?=$row1['reseller_company'];?>"  placeholder="Reseller Name" required>
                  </div>
                  <div class="form-group m-form__group">
                  ...
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Phone </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_phone" id="reseller_phone" value="<?=$row1['reseller_phone'];?>" placeholder="Phone" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Username </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_username" id="reseller_username" value="<?=$row1['reseller_username'];?>" placeholder="Username" readonly>
                  </div>
                  <div class="form-group m-form__group">
                  ...
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Address </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_address" id="reseller_address" value="<?=$row1['reseller_address'];?>" placeholder="Address" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> City </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_city" id="reseller_city" value="<?=$row1['reseller_city'];?>" placeholder="City" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> State </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_state" id="reseller_state" value="<?=$row1['reseller_state'];?>" placeholder="State" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Select Country </label>
                    <?
              $strSQL1 = " SELECT * FROM admin_country WHERE country_status = 'T' ORDER BY id ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_country" id="reseller_country">
                      <option style="font-family: 'Roboto', sans-serif;" value="<?=$row1['reseller_country'];?>">
                      <?=$row1['reseller_country'];?>
                      </option>
                      <? while($objResult1 = mysql_fetch_array($objQuery1)) { ?>
                      <option style="font-family: 'Roboto', sans-serif;" value="<?=$objResult1['country_name'];?>">
                      <?=$objResult1['country_name'];?>
                      </option>
                      <? } ?>
                    </select>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Zipcode </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_zipcode" id="reseller_zipcode" value="<?=$row1['reseller_zipcode'];?>" placeholder="Zipcode" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Show Price </label>
                    <br>
                    <label class="m-radio">
                      <? if ($row1['reseller_show_price'] == 'Yes') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_show_price" id="reseller_show_price" value="Yes" checked>
                      <? } else if ($row1['reseller_show_price'] != 'Yes') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_show_price" id="reseller_show_price" value="Yes">
                      <? } ?>
                      Yes <span></span> </label>
                    <label class="m-radio">
                      <? if ($row1['reseller_show_price'] == 'No') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_show_price" id="reseller_show_price" value="No" checked>
                      <? } else if ($row1['reseller_show_price'] != 'No') { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="reseller_show_price" id="reseller_show_price" value="No">
                      <? } ?>
                      No <span></span> </label>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> VG Order Number </label>
                    <label style="font-family: 'Roboto', sans-serif;">
                      <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_order_font" id="reseller_order_font" value="<?=$row1['reseller_order_font'];?>" placeholder="Example: VG" required>
                    </label>
                    <label style="font-family: 'Roboto', sans-serif;"> - </label>
                    <label style="font-family: 'Roboto', sans-serif;">
                      <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="reseller_order_number" id="reseller_order_number" value="<?=$row1['reseller_order_number'];?>" placeholder="Example: 101" maxlength="6" OnKeyPress="return chkNumber(this)" required>
                    </label>
                    <label style="font-family: 'Roboto', sans-serif;"> Example:
                      <?=$row1['reseller_order_font'];?>
                      -
                      <?=$row1['reseller_order_number'];?>
                    </label>
                    <br>
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> NOTE: Use the above code for invoice number and followed automatically on reseller invoices </span> </div>
                </div>
