        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable">
              <thead>
                <tr>
                  <th style="font-family: 'Roboto', sans-serif;"> Item </th>
                  <th style="font-family: 'Roboto', sans-serif;"> File PDF </th>
              ...
              <tbody>
                ...
                <tr>
                  <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["orderform_item"]?></td>
                  <td style="font-family: 'Roboto', sans-serif;"><a href="../../images/orderform/<?=$objResult1["orderform_file"]?>">Download</td>
                    </td>
                  <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?id=<?=$objResult1["id"]?>"> Update PDF </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
