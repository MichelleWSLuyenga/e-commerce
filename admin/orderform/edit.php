...
<?	
	...
	$sql1 =	" SELECT * FROM admin_orderform WHERE id = '$id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/orderform_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Item Name </label>
                    <input type="hidden" name="id" id="id" value="<?=$row1['id'];?>" required>
                    <input type="hidden" name="orderform_admin" id="orderform_admin" value="<?=$row_user['id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="orderform_item" id="orderform_item" value="<?=$row1['orderform_item'];?>" placeholder="Item Name" readonly>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;" for="exampleInputEmail1"> File PDF </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" style="font-family: 'Roboto', sans-serif;" name="orderform_file" id="orderform_file" value="<?=$row1['orderform_file'];?>">
                      <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Upload File PDF Only </span> </div>
                  </div>
                </div>
