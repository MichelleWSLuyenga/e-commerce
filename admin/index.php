      ...
      <div class="m-login__container">
        <div class="m-login__signin">
          <div class="m-login__head">
            ...
            <h3 class="m-login__title" style="font-family: 'Roboto', sans-serif;"> Sign In To Admin Reseller </h3>
          </div>
          <form class="m-login__form m-form" action="index_code.php" method="post">
            <div class="form-group m-form__group">
              <input class="form-control" type="text" name="reseller_username" id="reseller_username" placeholder="Username" required>
            </div>
            <div class="form-group m-form__group">
              <input class="form-control" type="password" name="reseller_password" id="reseller_password" placeholder="Password" required>
            </div>
            <div class="row m-login__form-sub">
              <div class="col m--align-left m-login__form-left"> </div>
              <div class="col m--align-right m-login__form-right" style="font-family: 'Roboto', sans-serif;"> <a href="javascript:;" id="m_login_forget_password" class="m-link"> Forget Password ? </a> </div>
            </div>
