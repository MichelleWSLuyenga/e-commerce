      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabricbrand_add_code.php" method="post">
				...
				?>
										<select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabricbrand_category" id="fabricbrand_category">
										...
										<span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Show all category created by admin </span>
								</div>
                <div class="form-group m-form__group">
                  ...
                  <label class="m-checkbox">
                    <input type="checkbox" style="font-family: 'Roboto', sans-serif;" value="brand1">
                    Brand 1 <span></span> </label>
                    &nbsp;&nbsp;
                  <label class="m-checkbox">
                    <input type="checkbox" style="font-family: 'Roboto', sans-serif;" value="brand2">
                      Brand 2 <span></span> </label>
                      &nbsp;&nbsp;
                  <label class="m-checkbox">
                    <input type="checkbox" style="font-family: 'Roboto', sans-serif;" value="brand3">
                        Brand 3 <span></span> </label>
                        &nbsp;&nbsp;
                  <label class="m-checkbox">
                    <input type="checkbox" style="font-family: 'Roboto', sans-serif;" value="brand4">
                          Brand 4 <span></span> </label>
                          &nbsp;&nbsp;
                  <label class="m-checkbox">
                    <input type="checkbox" style="font-family: 'Roboto', sans-serif;" value="brand5">
                            Brand 5 <span></span> </label>
                            &nbsp;&nbsp;
                  <label class="m-checkbox">
                    <input type="checkbox" style="font-family: 'Roboto', sans-serif;" value="brand6">
                              Brand 6 <span></span> </label>
                              &nbsp;&nbsp;
                </div>
								<div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Fabric Brand Name </label>
                    <input type="hidden" name="fabricbrand_admin" id="fabricbrand_admin" value="<?=$row_user['id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabricbrand_name" id="fabricbrand_name" placeholder="Fabric Brand Name" required>
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> For Example Reymond </span> </div>
                </div>
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body">
            <!--begin: Datatable -->
            <?
              $strSQL1 = " SELECT DISTINCT(fabricbrand_name), fabricbrand_id FROM admin_fabricbrand WHERE fabricbrand_status = 'T' ORDER BY fabricbrand_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable">
              ...
              <thead>
                <tr>
                  ...
                  <th style="font-family: 'Roboto', sans-serif;"> Fabric Brand Name </th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["fabricbrand_name"]?></td>
									<td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["fabricbrand_category"]?></td>
                  <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?fabricbrand_id=<?=$objResult1["fabricbrand_id"]?>"> Edit </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
