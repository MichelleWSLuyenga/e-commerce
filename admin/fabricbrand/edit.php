              ...
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabricbrand_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabricbrand_name" id="fabricbrand_name" value="<?=$row1['fabricbrand_name'];?>" placeholder="Fabric Type Name" required>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-family: 'Roboto', sans-serif;"><a href="delete.php?fabricbrand_id=<?=$objResult1["fabricbrand_id"]?>"> Delete </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
