      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/subuser_add_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_username" id="admin_username" placeholder="Username" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Password (8)</label>
                    <input type="password" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_password" id="admin_password" maxlength="8" placeholder="Password" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> First Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_firstname" id="admin_firstname" placeholder="First Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Last Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_lastname" id="admin_lastname" placeholder="Last Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Email </label>
                    <input type="email" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_email" id="admin_email" placeholder="Email" required>
                  </div>
