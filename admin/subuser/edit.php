      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/subuser_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="hidden" name="admin_admin" id="admin_admin" value="<?=$row_user['id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_username" id="admin_username" value="<?=$row1['admin_username'];?>" placeholder="Username" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Password (8)</label>
                    <input type="password" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_password" id="admin_password" value="<?=$row1['admin_password'];?>" maxlength="8" placeholder="Password" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> First Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_firstname" id="admin_firstname" value="<?=$row1['admin_firstname'];?>" placeholder="First Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Last Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_lastname" id="admin_lastname" value="<?=$row1['admin_lastname'];?>" placeholder="Last Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Email </label>
                    <input type="email" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="admin_email" id="admin_email" value="<?=$row1['admin_email'];?>" placeholder="Email" required>
                  </div>
                  <div class="m-form__group form-group">
                    ...
                    <div class="m-checkbox-inline">
                      <label class="m-checkbox" style="font-family: 'Roboto', sans-serif;">
                        <? if ($row1["admin_status_country"] == "T") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_country" id="admin_status_country" value="T" checked>
                        <? } else if ($row1["admin_status_country"] == "") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_country" id="admin_status_country" value="T">
                        <? } ?>
                        Country <span></span> </label>
                      <label class="m-checkbox" style="font-family: 'Roboto', sans-serif;">
                        <? if ($row1["admin_status_fabrictype"] == "T") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_fabrictype" id="admin_status_fabrictype" value="T" checked>
                        <? } else if ($row1["admin_status_fabrictype"] == "") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_fabrictype" id="admin_status_fabrictype" value="T">
                        <? } ?>
                        Fabric Type <span></span> </label>
                      <label class="m-checkbox" style="font-family: 'Roboto', sans-serif;">
                        <? if ($row1["admin_status_brandtype"] == "T") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_brandtype" id="admin_status_brandtype" value="T" checked>
                        <? } else if ($row1["admin_status_brandtype"] == "") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_brandtype" id="admin_status_brandtype" value="T">
                        <? } ?>
                        Brand Type <span></span> </label>
                      <label class="m-checkbox" style="font-family: 'Roboto', sans-serif;">
                        <? if ($row1["admin_status_orders"] == "T") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_orders" id="admin_status_orders" value="T" checked>
                        <? } else if ($row1["admin_status_orders"] == "") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_orders" id="admin_status_orders" value="T">
                        <? } ?>
                        Orders <span></span> </label>
                      <label class="m-checkbox" style="font-family: 'Roboto', sans-serif;">
                        <? if ($row1["admin_status_reports"] == "T") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_reports" id="admin_status_reports" value="T" checked>
                        <? } else if ($row1["admin_status_reports"] == "") { ?>
                        <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="admin_status_reports" id="admin_status_reports" value="T">
                        <? } ?>
                        Reports <span></span> </label>
                    </div>
