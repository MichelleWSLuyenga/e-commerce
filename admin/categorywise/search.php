          ...
          <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
              ...
              <div id="printable"><br>
                ...
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_price !='' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_company = '$company' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
		      ?>
                <? } else if ($reseller != "" && $start_date != "" && $end_date != "") { ?>
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_price !='' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_date BETWEEN '$start_date' AND '$end_date' AND checkout_company = '$company' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
		      ?>
                <? } else if ($reseller != "" && $start_date == "" && $end_date == "") { ?>
                <?
		      ...
		      ?>
                ...
                <table width="100%">
                  <thead>
                    <tr style="height:50px;">
                      ...
                      <th width="10%" style="border: 1px solid #c5c5c5; font-weight:100; vertical-align:middle;" align="center"><div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;" align="center"><strong> Reseller Name </strong></div></th>
				...
				?>
                    ...
                    <tr style="height:50px;">
                      ...
                      <? if ($report == 'Jacket' || $report == '') { ?>
                      <td width="5%" style="border: 1px solid #c5c5c5; font-weight:100; vertical-align:middle;" align="center"><? if ($reseller == "" && $start_date == "" && $end_date == "") { ?>
                        <?
