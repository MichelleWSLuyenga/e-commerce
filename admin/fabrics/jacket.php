	  			...
	  			?>
                    ...
                    <tr>
                      ...
                      <td style="font-family: 'Roboto', sans-serif;"><? if($objResult["fabrics_status"] == 'T') { ?>
                        ...
                        OUT OF STOCK
                        <? } ?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?id=<?=$objResult["id"]?>&&fabrics_product=jacket"> Edit </a></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="update.php?id=<?=$objResult["id"]?>&&fabrics_product=jacket&&fabrics_status=<?=$objResult["fabrics_status"]?>"> Change Stock </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
