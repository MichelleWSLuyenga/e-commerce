                ...
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="country_name" id="country_name" placeholder="Country Name" required>
									...
									<div class="form-group m-form__group">
										<label style="font-family: 'Roboto', sans-serif;"> Country Currency </label>
										<input type="hidden" name="country_currency" id="country_currency" value="<?=$row_user['country_currency'];?>" required>
										<input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="country_currency" id="country_currency" placeholder="Country Currency" required>
									</div>
                </div>
          ...
          <div class="m-portlet__body">
            ...
            <form name="frmMain" action="delete.php" method="post" OnSubmit="return onDelete();">
              <table class="table table-striped- table-bordered table-hover table-checkable">
                <thead>
                  <tr>
										<th style="font-family: 'Roboto', sans-serif;"><button type="submit" class="btn btn-danger" style="font-family: 'Roboto', sans-serif; margin-bottom: 10px;"> Delete </button><br>
											<!-- <input type="checkbox" name="checkall" id="checkall" onClick="check_uncheck_checkbox(this.checked);" /></th> -->
                    <th style="font-family: 'Roboto', sans-serif;"> Country Name </th>
										<th style="font-family: 'Roboto', sans-serif;"> Country Currency </th>
                ...
                <tbody>
                  ...
                  <tr>
										<td style="font-family: 'Roboto', sans-serif;"><input type="checkbox" name="checkme[]" value="<?php echo $objResult1["id"];?>"></td>
                    <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["country_name"]?></td>
										<td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["country_currency"]?></td>
