        ...
        <div class="col-md-12">
          <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
              ...
              <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_process = 'In-Process' AND checkout_date BETWEEN '$start_date' AND '$end_date' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
		  ?>
              <? } else if ($reseller != "" && $start_date == "" && $end_date == "") { ?>
              <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_process = 'In-Process' AND checkout_company = '$reseller' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
              <? } else if ($reseller != "" && $start_date != "" && $end_date != "") { ?>
              <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_process = 'In-Process' AND checkout_company = '$reseller' AND checkout_date BETWEEN '$start_date' AND '$end_date' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
              <? } else if ($reseller == "" && $start_date == "" && $end_date == "") { ?>
              <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_process = 'In-Process' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
              <? } ?>
              <table width="100%">
