...
<?	
	...
	$id = $_GET["id"];
	$lining_product = $_GET["lining_product"];
	
	if($lining_product == "jacket") {
	
	$sql1 =	" SELECT * FROM admin_lining_jacket WHERE id = '$id' ";
	$query1 = mysql_db_query($dbname, $sql1) or die("Can't Query1");
	$row1 = mysql_fetch_array($query1);
	
	} else if($lining_product == "overcoat") {
	
	$sql1 =	" SELECT * FROM admin_lining_overcoat WHERE id = '$id' ";
	$query1 = mysql_db_query($dbname, $sql1) or die("Can't Query1");
	$row1 = mysql_fetch_array($query1);
	
	} else if($lining_product == "pants") {
	
	$sql1 =	" SELECT * FROM admin_lining_pants WHERE id = '$id' ";
	$query1 = mysql_db_query($dbname, $sql1) or die("Can't Query1");
	$row1 = mysql_fetch_array($query1);
	
	} else if($lining_product == "suits") {
	
	$sql1 =	" SELECT * FROM admin_lining_suits WHERE id = '$id' ";
	$query1 = mysql_db_query($dbname, $sql1) or die("Can't Query1");
	$row1 = mysql_fetch_array($query1);
	
	} else if($lining_product == "vest") {
	
	$sql1 =	" SELECT * FROM admin_lining_vest WHERE id = '$id' ";
	$query1 = mysql_db_query($dbname, $sql1) or die("Can't Query1");
	$row1 = mysql_fetch_array($query1);
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/lining_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Select Lining Type or Brand Name </label>
                    &nbsp;&nbsp;
                    <input type="hidden" name="id" id="id" value="<?=$row1['id'];?>" required>
                    <input type="hidden" name="lining_admin" id="lining_admin" value="<?=$row_user['id'];?>" required>
                    <input type="hidden" name="lining_product" id="lining_product" value="<?=$lining_product;?>" required>
                    <label class="m-radio">
                      <? if ($row1['type'] != "") { ?>
                      <input type="radio" style="font-family: 'Roboto', sans-serif;" name="select_type" id="select_type" value="Lining Type" checked="checked" onClick="tab_select_type_one();">
                      Lining Type <span></span> </label>
                    &nbsp;&nbsp;
                    <? } else if ($row1['type'] == "") { ?>
                    <input type="radio" style="font-family: 'Roboto', sans-serif;" name="select_type" id="select_type" value="Lining Type" onClick="tab_select_type_one();">
                    Lining Type <span></span>
                    </label>
                    <? } ?>
                    <label class="m-radio">
                      <? if ($row1['brand'] != "") { ?>
                  ...
                  <? if ($row1['type'] != "") { ?>
                  <div class="form-group m-form__group" id="select_lining_type">
                    <label style="font-family: 'Roboto', sans-serif;"> Select Lining Type </label>
                    <?
			  ...
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_type" id="lining_type">
                  ...
                  <? } else if ($row1['type'] == "") { ?>
                  <div class="form-group m-form__group" id="select_lining_type" style="display:none;">
                    <label style="font-family: 'Roboto', sans-serif;"> Select Lining Type </label>
                    <?
              $strSQL1 = " SELECT DISTINCT(fabrictype_name) FROM admin_fabrictype WHERE fabrictype_status = 'T' ORDER BY fabrictype_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                  ...
                  <? } ?>
                  <? if ($row1['brand'] != "") { ?>
                  <div class="form-group m-form__group" id="select_lining_brand">
			  ...
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_brand" id="lining_brand">
                    ...
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Show all category created by admin </span> </div>
                  <? } else if ($row1['brand'] == "") { ?>
                  <div class="form-group m-form__group" id="select_lining_brand" style="display:none;">
                    <label style="font-family: 'Roboto', sans-serif;"> Select Brand Name </label>
                    <?
              $strSQL2 = " SELECT DISTINCT(fabricbrand_name) FROM admin_fabricbrand WHERE fabricbrand_status = 'T' ORDER BY fabricbrand_name ASC ";
			  $objQuery2 = mysql_query($strSQL2) or die ("Error Query [".$strSQL2."]");
			  ?>
                  ...
                  <? } ?>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Lining Number </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_number" id="lining_number" value="<?=$row1['fabricno'];?>" placeholder="Lining Number" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Lining Color </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_color" id="lining_color" value="<?=$row1['color'];?>" placeholder="Lining Color">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Lining Pattern </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_pattern" id="lining_pattern" value="<?=$row1['pattern'];?>" placeholder="Lining Pattern">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;" for="exampleInputEmail1"> Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" style="font-family: 'Roboto', sans-serif;" name="lining_image" id="lining_image" value="<?=$row1['image'];?>">
                      <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Width: 500 * Height: 500 Only </span> </div>
                  </div>
                  <div class="form-group m-form__group"> <img class="img-responsive" src="../../images/lining/<?=$row1['image'];?>?v=1001" width="150" height="150" onerror="this.src='../../images/lining/0.jpg?v=1001';"> </div>
                </div>
...
<script type="text/javascript"> function tab_select_type_one(){ document.getElementById("select_lining_type").style.display="block",document.getElementById("select_lining_brand").style.display="none"} </script> 
<script type="text/javascript"> function tab_select_type_two(){ document.getElementById("select_lining_type").style.display="none",document.getElementById("select_lining_brand").style.display="block"} </script> 
<!--end::Base Scripts -->
</body>
<!-- end::Body -->
</html>
