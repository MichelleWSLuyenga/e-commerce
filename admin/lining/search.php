            ...
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable">
                  <thead>
                    <tr>
                      <th style="font-family: 'Roboto', sans-serif;"> Lining No </th>
                  ...
                  <tbody>
                    <? 
	  				$strSQL = " SELECT * FROM admin_fabrics_lining WHERE fabricno LIKE '%$fabrics_number%' ";
	  			...
	  			?>
                    ...
                    <tr>
                      ...
                      <td style="font-family: 'Roboto', sans-serif;"><a href="update.php?id=<?=$objResult["id"]?>&&lining_status=<?=$objResult["fabrics_status"]?>"> Change Stock </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
