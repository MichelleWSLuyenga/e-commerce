            ...
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable">
                  ...
                  <tbody>
                    <?
	  				$strSQL = " SELECT * FROM admin_lining_jacket ";
	  			...
	  			?>
                    ...
                    <tr>
                      ...
                      <td style="font-family: 'Roboto', sans-serif;"><? if($objResult["fabrics_status"] == 'T') { ?>
                        ...
                        OUT OF STOCK
                        <? } ?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?id=<?=$objResult["id"]?>&&lining_product=jacket"> Edit </a></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="update.php?id=<?=$objResult["id"]?>&&lining_product=jacket&&lining_status=<?=$objResult["fabrics_status"]?>"> Change Stock </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
