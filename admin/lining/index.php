      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/lining_add_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="lining_jacket" id="lining_jacket" value="jacket">
                      Jacket <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="lining_overcoat" id="lining_overcoat" value="overcoat">
                      Overcoat <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="lining_pants" id="lining_pants" value="pants">
                      Pants <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="lining_suits" id="lining_suits" value="suits">
                      Suits <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="lining_vest" id="lining_vest" value="vest">
                      Vest <span></span> </label>
                    &nbsp;&nbsp; </div>
                  <div class="form-group m-form__group">
			  ...
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_type" id="lining_type">
                      <option style="font-family: 'Roboto', sans-serif;" value="">--Select Lining Type--</option>
			  ...
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_brand" id="lining_brand">
                      <option style="font-family: 'Roboto', sans-serif;" value="">--Select Brand Name--</option>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_number" id="lining_number" placeholder="Lining Number" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Lining Color </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_color" id="lining_color" placeholder="Lining Color">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Lining Pattern </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="lining_pattern" id="lining_pattern" placeholder="Lining Pattern">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;" for="exampleInputEmail1"> Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" style="font-family: 'Roboto', sans-serif;" name="lining_image" id="lining_image">
