                ...
                <table class="table table-striped- table-bordered table-hover table-checkable">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th style="font-family: 'Roboto', sans-serif;"> Button No </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Type </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Description </th>
	  			...
	  			?>
                    ...
                    <tr>
											<td style="font-family: 'Roboto', sans-serif;"><input type="checkbox" name="chkDel[]" value="<?php echo $objResult['id'];?>"></td><!--Here-->
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult["buttonno"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult["type"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult["description"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><? if($objResult["buttons_status"] == 'T') { ?>
                        AVAILABLE
                        <? } else if($objResult["buttons_status"] == 'F') { ?>
                        OUT OF STOCK
                        <? } ?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?id=<?=$objResult["id"]?>&&buttons_product=overcoat"> Edit </a></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="update.php?id=<?=$objResult["id"]?>&&buttons_product=overcoat&&buttons_status=<?=$objResult["buttons_status"]?>"> Change Stock </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
