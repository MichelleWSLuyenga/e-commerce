	  			...
	  			?>
                    ...
                    <tr>
                      ...
                      <td style="font-family: 'Roboto', sans-serif;"><? if($objResult["buttons_status"] == 'T') { ?>
                        ...
                        OUT OF STOCK
                        <? } ?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?id=<?=$objResult["id"]?>&&buttons_product=vest"> Edit </a></td>
                      <td style="font-family: 'Roboto', sans-serif;"><a href="update.php?id=<?=$objResult["id"]?>&&buttons_product=vest&&buttons_status=<?=$objResult["buttons_status"]?>"> Change Stock </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
