          ...
          <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
              <div id="non-printable">
                <div align="left">
                  <form class="m-form m-form--fit m-form--label-align-right" action="search.php" method="post">
                    <div class="col-md-12">
                      <label style="font-family: 'Roboto', sans-serif;"> Search by Order No &nbsp;&nbsp;&nbsp;&nbsp; </label>
                      <label style="font-family: 'Roboto', sans-serif;">
                        <input type="text" class="form-control m-input" name="orderno" id="orderno" value="<?=$orderno?>">
                      </label>
                      <br>
              ...
              <div id="printable"><br>
                ...
                <div style="font-family: 'Roboto', sans-serif; text-transform:uppercase; color:#000000; font-size:16px; letter-spacing:1px;" align="center"><strong> ORDERS </strong></div>
                ...
                <? if ($orderno != "") { ?>
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_company = '$company' AND checkout_order LIKE '%$orderno%' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
		  ?>
                <? } else if ($start_date != "" && $end_date != "") { ?>
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_company = '$company' AND checkout_date BETWEEN '$start_date' AND '$end_date' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
		  ?>
                <? } else if ($start_date == "" && $end_date == "") { ?>
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_company = '$company' AND checkout_company = '$reseller' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                <? } else if ($start_date != "" && $end_date != "") { ?>
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_company = '$company' AND checkout_company = '$reseller' AND checkout_date BETWEEN '$start_date' AND '$end_date' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                <? } else if ($start_date == "" && $end_date == "") { ?>
                <?
              $strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_send = 'send' AND checkout_company = '$company' ORDER BY id DESC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                <? } ?>
                <table width="100%">
                  <thead>
                    <tr style="height:50px;">
                      ...
                      <th width="10%" style="border: 1px solid #c5c5c5; font-weight:100; vertical-align:middle;" align="center"><div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;" align="center"><strong> View & Print Order </strong></div></th>
                      <th width="10%" style="border: 1px solid #c5c5c5; font-weight:100; vertical-align:middle;" align="center"><div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;" align="center"><strong> Print PDF & Download Invoice PDF (Order No) </strong></div></th>
                    </tr>
                  </thead>
                  <tbody>
					...
					?>
                      ...
                      <td style="border: 1px solid #c5c5c5; font-weight:100; vertical-align:middle;" align="center"><a href="view.php?order_id=<?=$objResult1['checkout_orderid'];?>&&user=<?=$objResult1["checkout_company"]?>" target="_blank">
