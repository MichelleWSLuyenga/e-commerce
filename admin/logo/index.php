...
<?	
	...
	$sql1 =	" SELECT * FROM admin_uploadlogo WHERE id = '$id' ";
                    ...
                    <div class="m-dropdown__body">
                      <div class="m-dropdown__content">
                        <ul class="m-nav m-nav--skin-light">
                          ...
                          <li class="m-nav__item"> <a href="../include/logout.php" class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" style="font-family: 'Roboto', sans-serif;"> Logout </a> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
      ...
      <div class="m-content">
        <div class="row">
              ...
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption" align="center">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text" style="font-family: 'Roboto', sans-serif; text-transform:uppercase;"><strong> Upload Logo Picture </strong></h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/uploadlogo_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="hidden" name="id" id="id" value="<?=$row_user['id'];?>" required>
                      <input type="hidden" name="uploadlogo_admin" id="uploadlogo_admin" value="<?=$row_user['id'];?>" required>
                      <input type="file" name="uploadlogo_image" id="uploadlogo_image" value="<?=$row1['uploadlogo_image'];?>">
                    </div>
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Width: 250 * Height: 55 Only </span>
                    <div class="form-group m-form__group"> <img class="img-responsive" src="../../images/logo/<?=$row1['uploadlogo_image'];?>?v=1001" width="250" height="55" onerror="this.src='../../images/logo/0.jpg?v=1001';" width="150" height="150"> </div>
                  </div>
                </div>
