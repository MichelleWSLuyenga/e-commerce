                ...
                <table class="table table-striped- table-bordered table-hover table-checkable">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th style="font-family: 'Roboto', sans-serif;"> Tie No </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Color </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Pattern </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Design </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Width </th>
                      <th style="font-family: 'Roboto', sans-serif;"> Length </th>
                  ...
                  <tbody>
                    <?
	  				$strSQL = " SELECT * FROM admin_fabrics_ties ";
	  			...
	  			?>
                    ...
                    <tr>
                      ...
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult["design"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult["width"]?></td>
                      <td style="font-family: 'Roboto', sans-serif;"><?=$objResult["length"]?></td>
                      ...
                      <td style="font-family: 'Roboto', sans-serif;"><a href="update.php?id=<?=$objResult["id"]?>&&tie_status=<?=$objResult["fabrics_status"]?>"> Change Stock </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
