...
<?
	...
	$sql1 =	" SELECT * FROM admin_fabrics_ties WHERE id = '$id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/tie_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Tie Number </label>
                    <input type="hidden" name="id" id="id" value="<?=$row1['id'];?>" required>
                    <input type="hidden" name="tie_admin" id="tie_admin" value="<?=$row_user['id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="tie_number" id="tie_number" value="<?=$row1['fabricno'];?>" placeholder="Tie Number" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Tie Color </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="tie_color" id="tie_color" value="<?=$row1['color'];?>" placeholder="Tie Color">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Tie Pattern </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="tie_pattern" id="tie_pattern" value="<?=$row1['pattern'];?>" placeholder="Tie Pattern">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Tie Design </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="tie_design" id="tie_design" value="<?=$row1['design'];?>" placeholder="Tie Design">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Tie Width </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="tie_width" id="tie_width" value="<?=$row1['width'];?>" placeholder="Tie Width">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Tie Length </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="tie_length" id="tie_length" value="<?=$row1['length'];?>" placeholder="Tie Width">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;" for="exampleInputEmail1"> Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" style="font-family: 'Roboto', sans-serif;" name="tie_image" id="tie_image" value="<?=$row1['image'];?>">
                      <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Width: 500 * Height: 500 </span> </div>
                  </div>
                  <div class="form-group m-form__group"> <img class="img-responsive" src="../../images/ties/<?=$row1['image'];?>?v=1001" width="150" height="150" onerror="this.src='../../images/ties/0.jpg?v=1001';"> </div>
                </div>
