...
<?	
	...
	$sql1 =	" SELECT id, category_name, category_image, `category_".$id."`, category_status FROM admin_category WHERE id = '$category_id' ";
      ...
      <div class="m-content">
        <div class="row">
              ...
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption" align="center">
                  <div class="m-portlet__head-title">
                    ...
                    <strong> Upload Category Picture </strong>
                    </h3>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/uploadcategory_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="category_name" id="category_name" value="<?=$row1['category_name'];?>" placeholder="Category Name" readonly>
                  </div>
                  <div class="form-group m-form__group">
                    ...
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Width: 500 * Height: 700 Only </span> <br>
                    <? $images_product = $row1['3'] ?>
                    <? if ($images_product == "0") { ?>
                    <img class="img-responsive" src="../../images/category/<?=$row1['category_image'];?>?v=1001" width="150" height="200">
                    <? } else if ($images_product != "0") { ?>
                    <img class="img-responsive" src="../../images/category/<?=$images_product;?>?v=1001" width="150" height="200">
                    <? } ?>
                  </div>
                </div>
