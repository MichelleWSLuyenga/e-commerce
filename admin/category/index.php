      ...
      <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body"> 
            <!--begin: Datatable -->
            <?
            $strSQL1 = " SELECT id, category_name, category_image, `category_".$id."`, category_status FROM admin_category WHERE category_status = 'T' ORDER BY category_name ASC ";
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable">
              ...
              <tbody>
                ...
                <tr> 
                  ...
                  <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><? $images_product = $objResult1['3'] ?>
                    <? if ($images_product == "0") { ?>
                    <img class="img-responsive" src="../../images/category/<?=$objResult1['category_image'];?>?v=1001" width="150" height="200">
                    <? } else if ($images_product != "0") { ?>
                    <img class="img-responsive" src="../../images/category/<?=$images_product;?>?v=1001" width="150" height="200">
                    <? } ?></td>
                  <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?category_id=<?=$objResult1["id"]?>"> Edit </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
