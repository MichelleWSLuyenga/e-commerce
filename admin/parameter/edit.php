...
<?	
	...
	$sql1 =	" SELECT * FROM admin_parameter WHERE id = '$id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/parameter_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="hidden" name="parameter_admin" id="parameter_admin" value="<?=$row_user['id'];?>" required>
                    <?
              $strSQL1 = " SELECT * FROM admin_category WHERE category_status = 'T' ORDER BY category_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="parameter_category" id="parameter_category">
                      <option style="font-family: 'Roboto', sans-serif;" value="<?=$row1['parameter_category'];?>">
                      <?=$row1['parameter_category'];?>
                      </option>
                  ...
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Parameter </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="parameter_name" id="parameter_name" placeholder="Parameter" value="<?=$row1['parameter_name'];?>" required>
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> For Example chest 50 inches and above </span> </div>
                </div>
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body"> 
            <!--begin: Datatable -->
            <?
              $strSQL2 = " SELECT * FROM admin_parameter WHERE parameter_status = 'T' ORDER BY id ASC ";
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable">
              ...
              <tbody>
                ...
                <tr>
                  <td style="font-family: 'Roboto', sans-serif;"><?=$objResult2["parameter_category"]?></td>
                  <td style="font-family: 'Roboto', sans-serif;"><?=$objResult2["parameter_name"]?></td>
                  <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?id=<?=$objResult2["id"]?>"> Edit </a></td>
                  <td style="font-family: 'Roboto', sans-serif;"><a href="delete.php?id=<?=$objResult2["id"]?>"> Delete </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
