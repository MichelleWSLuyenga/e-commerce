...
<section class="body" style="background-color:#FFF;">
  ...
  <div class="inner-wrapper" style="background-color:#FFF;">
    <section role="main" class="content-body">
      ...
      <div class="row">
        <div class="row show-grid">
          <form class="form-horizontal form-bordered" action="../../include/multiple/customize_checkout.php" method="post" enctype="multipart/form-data" name="frmMain">
            <input type="hidden" id="checkout_orderid" name="checkout_orderid" value="<?=$orderid?>" required>
            <div class="col-md-6">
              <div class="col-md-12">
                <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:28px; letter-spacing:1px;"> <strong> Your Orders </strong> </div>
                <br>
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="col-md-12">
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:28px; letter-spacing:1px;"> <strong> Shipping Address </strong> </div>
                  <br>
                </div>
                <div class="col-md-12">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Company </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_company" id="checkout_company" value="<?=$row_user['reseller_company'];?>" readonly>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> FirstName </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_name" id="checkout_name" value="<?=$row_user['reseller_firstname'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Lastname </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_lastname" id="checkout_lastname" value="<?=$row_user['reseller_lastname'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Address </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_address" id="checkout_address" value="<?=$row_user['reseller_address'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> City </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_city" id="checkout_city" value="<?=$row_user['reseller_city'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> State </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_state" id="checkout_state" value="<?=$row_user['reseller_state'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Country </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_country" id="checkout_country" value="<?=$row_user['reseller_country'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Zipcode </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_zipcode" id="checkout_zipcode" value="<?=$row_user['reseller_zipcode'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Email </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_email" id="checkout_email" value="<?=$row_user['reseller_email'];?>" required>
                  <br>
                </div>
                <div class="col-md-6">
                  <label>
                  <div style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px;"> <strong> Phone </strong> </div>
                  </label>
                  <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="checkout_phone" id="checkout_phone" value="<?=$row_user['reseller_phone'];?>" required>
                  <br>
                </div>
                <div class="col-md-12" align="left">
                  <button class="btn btn-primary" type="submit" style="font-family: 'Roboto', sans-serif; color:#FFFFFF; font-size:14px; letter-spacing:1px;"> Save Order </button>
                </div>
              </div>
            </div>
          </form>
