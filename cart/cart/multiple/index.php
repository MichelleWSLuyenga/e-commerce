        ...
        <div class="row show-grid">
          <table class="table table-striped mb-none">
            <tbody>
              ...
              <tr class="gradeX">
                <td align="center" valign="middle"><a href="../../include/multiple/customize_remove.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>&&order_product=<?=$objResult1["order_product"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"><i class="fa fa-trash-o"></i></a></td>
                ...
                <td align="left" valign="middle"><? if ($order_product == "jacket") { ?>
                  <a href="../../include/multiple/customize_jacket_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "jeans") { ?>
                  <a href="../../include/multiple/customize_jeans_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "overcoat") { ?>
                  <a href="../../include/multiple/customize_overcoat_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "pants") { ?>
                  <a href="../../include/multiple/customize_pants_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "shirt") { ?>
                  <a href="../../include/multiple/customize_shirt_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "suits") { ?>
                  <a href="../../include/multiple/customize_suits_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "suits_with_vest") { ?>
                  <a href="../../include/multiple/customize_suits_with_vest_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "ties") { ?>
                  <a href="../../include/multiple/customize_ties_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "tuxedo_jacket") { ?>
                  <a href="../../include/multiple/customize_tuxedo_jacket_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "tuxedo_suits") { ?>
                  <a href="../../include/multiple/customize_tuxedo_suits_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "tuxedo_with_vest") { ?>
                  <a href="../../include/multiple/customize_tuxedo_with_vest_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } else if ($order_product == "vest") { ?>
                  <a href="../../include/multiple/customize_vest_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles </a>
                  <? } ?></td>
                <td align="left" valign="middle"><? if ($order_product == "jacket") { ?>
