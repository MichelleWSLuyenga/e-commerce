...
<section class="body" style="background-color:#FFFFFF;">
  ...
  <div class="inner-wrapper" style="background-color:#FFFFFF;">
    <section role="main" class="content-body">
      ...
      <br>
      <div align="center"> <a href="../../category/multiple/" class="btn btn-primary" style="font-family: 'Roboto', sans-serif; color:#FFFFFF; font-size:16px; letter-spacing:1px;"> Go Shopping </a> </div>
      <? } else if($orderid != '') { ?>
      <div class="row">
        <div class="row show-grid">
          <table class="table table-striped mb-none">
            <tbody>
              ...
              <tr class="gradeX">
                <td width="1%" align="center" valign="middle"><a href="../../include/multiple/customize_remove.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>&&order_product=<?=$objResult1["order_product"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"><i class="fa fa-trash-o"></i></a></td>
                <td width="5%" align="center" valign="middle"><? $order_product = $objResult1["order_product"]; ?>
                  ...
                  <img src="../../images/fabrics/<?=$fabrics_show?>?v=1001" width="70" height="70" onerror="this.src='../../images/fabrics/0.jpg?v=1001';">
                  <? } ?></td>
                <td width="35%" align="left" valign="middle" class="mobileHide"><? 
				...
				?>
				  ...
				  ?>
                  <? if ($objResult2["fabricno"] == "") { } else if ($objResult2["fabricno"] != "") { ?>
                  <table width="100%">
                    <?
				...
				?>
                  ...
                  <br>
                  <? if ($objResult2["fabricno"] == "") { } else if ($objResult2["fabricno"] != "") { ?>
                  <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:12px; letter-spacing:1px;"> Tie Number :
                    <?=$objResult2["fabricno"]?>
                  </div>
                  <? } ?>
                  <? } else if ($order_product == "tuxedo_jacket") { ?>
				...
				?>
                  ...
                  <? } ?>
                  <? } ?></td>
                <td width="35%" align="left" valign="middle"><? if ($order_product == "jacket" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/jacket/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/jacket/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "jeans" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/jeans/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/jeans/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "overcoat" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/overcoat/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/overcoat/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "pants" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/pants/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/pants/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "shirt" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/shirt/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/shirt/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "suits" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/suits/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/suits/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "suits_with_vest" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/suits_with_vest/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/suits_with_vest/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "ties" && $objResult2["fabricno"] != "") { ?>
                  <? } else if ($order_product == "tuxedo_jacket" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/tuxedo_jacket/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/tuxedo_jacket/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "tuxedo_suits" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/tuxedo_suits/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/tuxedo_suits/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "tuxedo_with_vest" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/tuxedo_with_vest/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/tuxedo_with_vest/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } else if ($order_product == "vest" && $objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/vest/fabric_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with same styles (change fabric only) </a> <br>
                  <br>
                  <a href="../../item/multiple/vest/styles_duplicate.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Duplicate another with fabric and same styles </a>
                  <? } ?></td>
                <td width="15%" align="left" valign="middle"><? if ($order_product == "jacket") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/jacket/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/jacket/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "jeans") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/jeans/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/jeans/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "overcoat") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/overcoat/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/overcoat/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "pants") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/pants/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/pants/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "shirt") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/shirt/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/shirt/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "suits") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/suits/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/suits/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "suits_with_vest") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/suits_with_vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/suits_with_vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "ties") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/ties/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/ties/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit </a>
                  <? } ?>
                  <? } else if ($order_product == "tuxedo_jacket") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/tuxedo_jacket/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/tuxedo_jacket/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "tuxedo_suits") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/tuxedo_suits/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/tuxedo_suits/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "tuxedo_with_vest") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/tuxedo_with_vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/tuxedo_with_vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } else if ($order_product == "vest") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/multiple/vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  <a href="../../item/multiple/vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Edit Fabric and Option </a>
                  <? } ?>
                  <? } ?></td>
                <td width="9%" align="left" valign="middle"><div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;">
          ...
          <br>
          <div align="right"> <a href="../../category/multiple/index.php?orderid=<?=$orderid?>" class="btn btn-primary" style="font-family: 'Roboto', sans-serif; color:#FFFFFF; font-size:16px; letter-spacing:1px;"> Continue Shopping </a> </div>
          <br>
          <?
          ...
          <br>
          <?
          $strSQL4 = " SELECT order_price FROM customize_order WHERE order_id = '$orderid' AND order_status = 'T' ORDER BY order_price DESC ";
		  $objQuery4 = mysql_query($strSQL4) or die("Can't Query4");
		  $objResult4 = mysql_fetch_array($objQuery4); 
		  ?>
          <? if ($objResult4["order_price"] != "") { ?>
          <div align="right"> <a href="../../measurements/multiple/index.php?orderid=<?=$orderid?>" class="btn btn-primary" style="font-family: 'Roboto', sans-serif; color:#FFFFFF; font-size:16px; letter-spacing:1px;"> Next Step to Measurements </a> </div>
          <? } ?>
        </div>
      </div>
      <? } ?>
