        ...
        <div class="row show-grid">
          <table class="table table-striped mb-none">
            <tbody>
              ...
              <tr class="gradeX">
                <td width="1%" align="center" valign="middle"><a href="../../include/single/customize_remove.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>&&order_product=<?=$objResult1["order_product"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"><i class="fa fa-trash-o"></i></a></td>
                ...
                <td width="15%" align="left" valign="middle"><? if ($order_product == "jacket") { ?>
                  ...
                  <a href="../../item/single/jacket/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  ...
                  <? } else if ($order_product == "jeans") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/jeans/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "overcoat") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/overcoat/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "pants") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/pants/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "shirt") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/shirt/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "suits") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/suits/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "suits_with_vest") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/suits_with_vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "ties") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/ties/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "tuxedo_jacket") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/tuxedo_jacket/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "tuxedo_suits") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/tuxedo_suits/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "tuxedo_with_vest") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/tuxedo_with_vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
                  ...
                  <? } else if ($order_product == "vest") { ?>
                  <? if ($objResult2["fabricno"] == "") { ?>
                  <a href="../../item/single/vest/edit.php?orderid=<?=$objResult1["order_id"]?>&&productid=<?=$objResult1["product_id"]?>" style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"> Add Fabric and Option </a>
                  <? } else if ($objResult2["fabricno"] != "") { ?>
