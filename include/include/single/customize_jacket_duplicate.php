...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$jacket_order_no', '$jacket_customer_name', '$order_price', '$order_product', '$jacket_fabric_no', '$jacket_date', '$jacket_time', '$jacket_ip', '$jacket_status') ";
