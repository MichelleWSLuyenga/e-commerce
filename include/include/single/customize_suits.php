...
if (($suits_jacket_measurement_chest >= '50' && $suits_jacket_measurement_chest <= '52') || ($suits_jacket_measurement_waist_upper >= '50' && $suits_jacket_measurement_waist_upper <= '52') || ($suits_jacket_measurement_waist_lower >= '50' && $suits_jacket_measurement_waist_lower <= '52') || ($suits_jacket_measurement_hips >= '50' && $suits_jacket_measurement_hips <= '52')) {
...
} else if (($suits_jacket_measurement_chest >= '52.5' && $suits_jacket_measurement_chest <= '56') || ($suits_jacket_measurement_waist_upper >= '52.5' && $suits_jacket_measurement_waist_upper <= '56') || ($suits_jacket_measurement_waist_lower >= '52.5' && $suits_jacket_measurement_waist_lower <= '56') || ($suits_jacket_measurement_hips >= '52.5' && $suits_jacket_measurement_hips <= '56')) {
...
} else if (($suits_jacket_measurement_chest >= '56.5' && $suits_jacket_measurement_chest <= '60') || ($suits_jacket_measurement_waist_upper >= '56.5' && $suits_jacket_measurement_waist_upper <= '60') || ($suits_jacket_measurement_waist_lower >= '56.5' && $suits_jacket_measurement_waist_lower <= '60') || ($suits_jacket_measurement_hips >= '56.5' && $suits_jacket_measurement_hips <= '60')) {
...
} else if (($suits_jacket_measurement_chest >= '60.5' && $suits_jacket_measurement_chest <= '64') || ($suits_jacket_measurement_waist_upper >= '60.5' && $suits_jacket_measurement_waist_upper <= '64') || ($suits_jacket_measurement_waist_lower >= '60.5' && $suits_jacket_measurement_waist_lower <= '64') || ($suits_jacket_measurement_hips >= '60.5' && $suits_jacket_measurement_hips <= '64')) {
...
} else if (($suits_jacket_measurement_chest >= '64.5' && $suits_jacket_measurement_chest <= '68') || ($suits_jacket_measurement_waist_upper >= '64.5' && $suits_jacket_measurement_waist_upper <= '68') || ($suits_jacket_measurement_waist_lower >= '64.5' && $suits_jacket_measurement_waist_lower <= '68') || ($suits_jacket_measurement_hips >= '64.5' && $suits_jacket_measurement_hips <= '68')) {
...
$sql15 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$suits_order_no', '$suits_customer_name', '$suits_price_2', '$order_product', '$suits_fabric_no_2', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");

$sql16 = " INSERT INTO customize_suits_design (id, order_id, product_id, suits_customer_name, suits_order_no, suits_order_date, suits_delivery_date, suits_fabric_no, suits_lining_no, suits_jacket_style, suits_lapel_style, suits_lapel_width, suits_lapel_move, suits_lapel_color, suits_real_lapel_boutonniere, suits_vent_style, suits_pocket_style, suits_chest_pocket, suits_shoulder_construction, suits_sleeve_button, suits_cuff, suits_all_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_button, suits_lining_style, suits_canvas, suits_jacket_button_number, suits_jacket_thread_on_button, suits_jacket_button_hole_color, suits_pick_stitch, suits_pick_stitch_lapel_color, suits_pick_stitch_pocket_color, suits_pick_stitch_sleeves, suits_pick_stitch_vest, suits_embroidery_inside_initial_or_name, suits_embroidery_inside_color, suits_embroidery_inside_design, suits_embroidery_collar_initial_or_name, suits_embroidery_collar_color, suits_embroidery_collar_design, suits_brand, suits_elbow_patch, suits_collar_felt_color, suits_front_pleat, suits_front_pocket, suits_back_pocket, suits_no_back_pocket, suits_pants_back_button_number, suits_pants_button_number, suits_pants_thread_on_button, suits_pants_button_hole_color, suits_fastening, suits_fly_option, suits_fly_option_zip, suits_band_edge_style, suits_very_extended_waistband, suits_waistband_width, suits_pants_cuff, suits_pants_cuff_width, suits_belt, suits_pants_lining_style, suits_embroidery_waist_initial_or_name, suits_embroidery_waist_color, suits_embroidery_waist_design, suits_embroidery_cuffs_initial_or_name, suits_embroidery_cuffs_color, suits_embroidery_cuffs_design, suits_pants_brand, suits_coin_pocket_inside, suits_suspender_buttons_inside, suits_split_tabs_back, suits_tuxedo_satin, suits_tuxedo_satin_waist_band, suits_date, suits_time, suits_ip, suits_status) VALUES ('$id_suits', '$order_id', '$product_id', '$suits_customer_name', '$suits_order_no', '$suits_order_date', '$suits_delivery_date', '$suits_fabric_no_2', '$suits_lining_no_2', '$suits_jacket_style', '$suits_lapel_style', '$suits_lapel_width', '$suits_lapel_move', '$suits_lapel_color', '$suits_real_lapel_boutonniere', '$suits_vent_style', '$suits_pocket_style', '$suits_chest_pocket', '$suits_shoulder_construction', '$suits_sleeve_button', '$suits_cuff', '$suits_all_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_button', '$suits_lining_style', '$suits_canvas', '$suits_jacket_button_number', '$suits_jacket_thread_on_button', '$suits_jacket_button_hole_color', '$suits_pick_stitch', '$suits_pick_stitch_lapel_color', '$suits_pick_stitch_pocket_color', '$suits_pick_stitch_sleeves', '$suits_pick_stitch_vest', '$suits_embroidery_inside_initial_or_name', '$suits_embroidery_inside_color', '$suits_embroidery_inside_design', '$suits_embroidery_collar_initial_or_name', '$suits_embroidery_collar_color', '$suits_embroidery_collar_design', '$suits_brand', '$suits_elbow_patch', '$suits_collar_felt_color', '$suits_front_pleat', '$suits_front_pocket', '$suits_back_pocket', '$suits_no_back_pocket', '$suits_pants_back_button_number', '$suits_pants_button_number', '$suits_pants_thread_on_button', '$suits_pants_button_hole_color', '$suits_fastening', '$suits_fly_option', '$suits_fly_option_zip', '$suits_band_edge_style', '$suits_very_extended_waistband', '$suits_waistband_width', '$suits_pants_cuff', '$suits_pants_cuff_width', '$suits_belt', '$suits_pants_lining_style', '$suits_embroidery_waist_initial_or_name', '$suits_embroidery_waist_color', '$suits_embroidery_waist_design', '$suits_embroidery_cuffs_initial_or_name', '$suits_embroidery_cuffs_color', '$suits_embroidery_cuffs_design', '$suits_pants_brand', '$suits_coin_pocket_inside', '$suits_suspender_buttons_inside', '$suits_split_tabs_back', '$suits_tuxedo_satin', '$suits_tuxedo_satin_waist_band', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query16 = mysql_query($sql16) or die("Can't Query16");
...
$sql15 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$suits_order_no', '$suits_customer_name', '$suits_price_3', '$order_product', '$suits_fabric_no_3', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");

$sql16 = " INSERT INTO customize_suits_design (id, order_id, product_id, suits_customer_name, suits_order_no, suits_order_date, suits_delivery_date, suits_fabric_no, suits_lining_no, suits_jacket_style, suits_lapel_style, suits_lapel_width, suits_lapel_move, suits_lapel_color, suits_real_lapel_boutonniere, suits_vent_style, suits_pocket_style, suits_chest_pocket, suits_shoulder_construction, suits_sleeve_button, suits_cuff, suits_all_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_button, suits_lining_style, suits_canvas, suits_jacket_button_number, suits_jacket_thread_on_button, suits_jacket_button_hole_color, suits_pick_stitch, suits_pick_stitch_lapel_color, suits_pick_stitch_pocket_color, suits_pick_stitch_sleeves, suits_pick_stitch_vest, suits_embroidery_inside_initial_or_name, suits_embroidery_inside_color, suits_embroidery_inside_design, suits_embroidery_collar_initial_or_name, suits_embroidery_collar_color, suits_embroidery_collar_design, suits_brand, suits_elbow_patch, suits_collar_felt_color, suits_front_pleat, suits_front_pocket, suits_back_pocket, suits_no_back_pocket, suits_pants_back_button_number, suits_pants_button_number, suits_pants_thread_on_button, suits_pants_button_hole_color, suits_fastening, suits_fly_option, suits_fly_option_zip, suits_band_edge_style, suits_very_extended_waistband, suits_waistband_width, suits_pants_cuff, suits_pants_cuff_width, suits_belt, suits_pants_lining_style, suits_embroidery_waist_initial_or_name, suits_embroidery_waist_color, suits_embroidery_waist_design, suits_embroidery_cuffs_initial_or_name, suits_embroidery_cuffs_color, suits_embroidery_cuffs_design, suits_pants_brand, suits_coin_pocket_inside, suits_suspender_buttons_inside, suits_split_tabs_back, suits_tuxedo_satin, suits_tuxedo_satin_waist_band, suits_date, suits_time, suits_ip, suits_status) VALUES ('$id_suits', '$order_id', '$product_id', '$suits_customer_name', '$suits_order_no', '$suits_order_date', '$suits_delivery_date', '$suits_fabric_no_3', '$suits_lining_no_3', '$suits_jacket_style', '$suits_lapel_style', '$suits_lapel_width', '$suits_lapel_move', '$suits_lapel_color', '$suits_real_lapel_boutonniere', '$suits_vent_style', '$suits_pocket_style', '$suits_chest_pocket', '$suits_shoulder_construction', '$suits_sleeve_button', '$suits_cuff', '$suits_all_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_button', '$suits_lining_style', '$suits_canvas', '$suits_jacket_button_number', '$suits_jacket_thread_on_button', '$suits_jacket_button_hole_color', '$suits_pick_stitch', '$suits_pick_stitch_lapel_color', '$suits_pick_stitch_pocket_color', '$suits_pick_stitch_sleeves', '$suits_pick_stitch_vest', '$suits_embroidery_inside_initial_or_name', '$suits_embroidery_inside_color', '$suits_embroidery_inside_design', '$suits_embroidery_collar_initial_or_name', '$suits_embroidery_collar_color', '$suits_embroidery_collar_design', '$suits_brand', '$suits_elbow_patch', '$suits_collar_felt_color', '$suits_front_pleat', '$suits_front_pocket', '$suits_back_pocket', '$suits_no_back_pocket', '$suits_pants_back_button_number', '$suits_pants_button_number', '$suits_pants_thread_on_button', '$suits_pants_button_hole_color', '$suits_fastening', '$suits_fly_option', '$suits_fly_option_zip', '$suits_band_edge_style', '$suits_very_extended_waistband', '$suits_waistband_width', '$suits_pants_cuff', '$suits_pants_cuff_width', '$suits_belt', '$suits_pants_lining_style', '$suits_embroidery_waist_initial_or_name', '$suits_embroidery_waist_color', '$suits_embroidery_waist_design', '$suits_embroidery_cuffs_initial_or_name', '$suits_embroidery_cuffs_color', '$suits_embroidery_cuffs_design', '$suits_pants_brand', '$suits_coin_pocket_inside', '$suits_suspender_buttons_inside', '$suits_split_tabs_back', '$suits_tuxedo_satin', '$suits_tuxedo_satin_waist_band', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query16 = mysql_query($sql16) or die("Can't Query16");
...
$sql15 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$suits_order_no', '$suits_customer_name', '$suits_price_4', '$order_product', '$suits_fabric_no_4', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");

$sql16 = " INSERT INTO customize_suits_design (id, order_id, product_id, suits_customer_name, suits_order_no, suits_order_date, suits_delivery_date, suits_fabric_no, suits_lining_no, suits_jacket_style, suits_lapel_style, suits_lapel_width, suits_lapel_move, suits_lapel_color, suits_real_lapel_boutonniere, suits_vent_style, suits_pocket_style, suits_chest_pocket, suits_shoulder_construction, suits_sleeve_button, suits_cuff, suits_all_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_button, suits_lining_style, suits_canvas, suits_jacket_button_number, suits_jacket_thread_on_button, suits_jacket_button_hole_color, suits_pick_stitch, suits_pick_stitch_lapel_color, suits_pick_stitch_pocket_color, suits_pick_stitch_sleeves, suits_pick_stitch_vest, suits_embroidery_inside_initial_or_name, suits_embroidery_inside_color, suits_embroidery_inside_design, suits_embroidery_collar_initial_or_name, suits_embroidery_collar_color, suits_embroidery_collar_design, suits_brand, suits_elbow_patch, suits_collar_felt_color, suits_front_pleat, suits_front_pocket, suits_back_pocket, suits_no_back_pocket, suits_pants_back_button_number, suits_pants_button_number, suits_pants_thread_on_button, suits_pants_button_hole_color, suits_fastening, suits_fly_option, suits_fly_option_zip, suits_band_edge_style, suits_very_extended_waistband, suits_waistband_width, suits_pants_cuff, suits_pants_cuff_width, suits_belt, suits_pants_lining_style, suits_embroidery_waist_initial_or_name, suits_embroidery_waist_color, suits_embroidery_waist_design, suits_embroidery_cuffs_initial_or_name, suits_embroidery_cuffs_color, suits_embroidery_cuffs_design, suits_pants_brand, suits_coin_pocket_inside, suits_suspender_buttons_inside, suits_split_tabs_back, suits_tuxedo_satin, suits_tuxedo_satin_waist_band, suits_date, suits_time, suits_ip, suits_status) VALUES ('$id_suits', '$order_id', '$product_id', '$suits_customer_name', '$suits_order_no', '$suits_order_date', '$suits_delivery_date', '$suits_fabric_no_4', '$suits_lining_no_4', '$suits_jacket_style', '$suits_lapel_style', '$suits_lapel_width', '$suits_lapel_move', '$suits_lapel_color', '$suits_real_lapel_boutonniere', '$suits_vent_style', '$suits_pocket_style', '$suits_chest_pocket', '$suits_shoulder_construction', '$suits_sleeve_button', '$suits_cuff', '$suits_all_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_button', '$suits_lining_style', '$suits_canvas', '$suits_jacket_button_number', '$suits_jacket_thread_on_button', '$suits_jacket_button_hole_color', '$suits_pick_stitch', '$suits_pick_stitch_lapel_color', '$suits_pick_stitch_pocket_color', '$suits_pick_stitch_sleeves', '$suits_pick_stitch_vest', '$suits_embroidery_inside_initial_or_name', '$suits_embroidery_inside_color', '$suits_embroidery_inside_design', '$suits_embroidery_collar_initial_or_name', '$suits_embroidery_collar_color', '$suits_embroidery_collar_design', '$suits_brand', '$suits_elbow_patch', '$suits_collar_felt_color', '$suits_front_pleat', '$suits_front_pocket', '$suits_back_pocket', '$suits_no_back_pocket', '$suits_pants_back_button_number', '$suits_pants_button_number', '$suits_pants_thread_on_button', '$suits_pants_button_hole_color', '$suits_fastening', '$suits_fly_option', '$suits_fly_option_zip', '$suits_band_edge_style', '$suits_very_extended_waistband', '$suits_waistband_width', '$suits_pants_cuff', '$suits_pants_cuff_width', '$suits_belt', '$suits_pants_lining_style', '$suits_embroidery_waist_initial_or_name', '$suits_embroidery_waist_color', '$suits_embroidery_waist_design', '$suits_embroidery_cuffs_initial_or_name', '$suits_embroidery_cuffs_color', '$suits_embroidery_cuffs_design', '$suits_pants_brand', '$suits_coin_pocket_inside', '$suits_suspender_buttons_inside', '$suits_split_tabs_back', '$suits_tuxedo_satin', '$suits_tuxedo_satin_waist_band', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query16 = mysql_query($sql16) or die("Can't Query16");
...
$sql15 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$suits_order_no', '$suits_customer_name', '$suits_price_5', '$order_product', '$suits_fabric_no_5', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");

$sql16 = " INSERT INTO customize_suits_design (id, order_id, product_id, suits_customer_name, suits_order_no, suits_order_date, suits_delivery_date, suits_fabric_no, suits_lining_no, suits_jacket_style, suits_lapel_style, suits_lapel_width, suits_lapel_move, suits_lapel_color, suits_real_lapel_boutonniere, suits_vent_style, suits_pocket_style, suits_chest_pocket, suits_shoulder_construction, suits_sleeve_button, suits_cuff, suits_all_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_button, suits_lining_style, suits_canvas, suits_jacket_button_number, suits_jacket_thread_on_button, suits_jacket_button_hole_color, suits_pick_stitch, suits_pick_stitch_lapel_color, suits_pick_stitch_pocket_color, suits_pick_stitch_sleeves, suits_pick_stitch_vest, suits_embroidery_inside_initial_or_name, suits_embroidery_inside_color, suits_embroidery_inside_design, suits_embroidery_collar_initial_or_name, suits_embroidery_collar_color, suits_embroidery_collar_design, suits_brand, suits_elbow_patch, suits_collar_felt_color, suits_front_pleat, suits_front_pocket, suits_back_pocket, suits_no_back_pocket, suits_pants_back_button_number, suits_pants_button_number, suits_pants_thread_on_button, suits_pants_button_hole_color, suits_fastening, suits_fly_option, suits_fly_option_zip, suits_band_edge_style, suits_very_extended_waistband, suits_waistband_width, suits_pants_cuff, suits_pants_cuff_width, suits_belt, suits_pants_lining_style, suits_embroidery_waist_initial_or_name, suits_embroidery_waist_color, suits_embroidery_waist_design, suits_embroidery_cuffs_initial_or_name, suits_embroidery_cuffs_color, suits_embroidery_cuffs_design, suits_pants_brand, suits_coin_pocket_inside, suits_suspender_buttons_inside, suits_split_tabs_back, suits_tuxedo_satin, suits_tuxedo_satin_waist_band, suits_date, suits_time, suits_ip, suits_status) VALUES ('$id_suits', '$order_id', '$product_id', '$suits_customer_name', '$suits_order_no', '$suits_order_date', '$suits_delivery_date', '$suits_fabric_no_5', '$suits_lining_no_5', '$suits_jacket_style', '$suits_lapel_style', '$suits_lapel_width', '$suits_lapel_move', '$suits_lapel_color', '$suits_real_lapel_boutonniere', '$suits_vent_style', '$suits_pocket_style', '$suits_chest_pocket', '$suits_shoulder_construction', '$suits_sleeve_button', '$suits_cuff', '$suits_all_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_button', '$suits_lining_style', '$suits_canvas', '$suits_jacket_button_number', '$suits_jacket_thread_on_button', '$suits_jacket_button_hole_color', '$suits_pick_stitch', '$suits_pick_stitch_lapel_color', '$suits_pick_stitch_pocket_color', '$suits_pick_stitch_sleeves', '$suits_pick_stitch_vest', '$suits_embroidery_inside_initial_or_name', '$suits_embroidery_inside_color', '$suits_embroidery_inside_design', '$suits_embroidery_collar_initial_or_name', '$suits_embroidery_collar_color', '$suits_embroidery_collar_design', '$suits_brand', '$suits_elbow_patch', '$suits_collar_felt_color', '$suits_front_pleat', '$suits_front_pocket', '$suits_back_pocket', '$suits_no_back_pocket', '$suits_pants_back_button_number', '$suits_pants_button_number', '$suits_pants_thread_on_button', '$suits_pants_button_hole_color', '$suits_fastening', '$suits_fly_option', '$suits_fly_option_zip', '$suits_band_edge_style', '$suits_very_extended_waistband', '$suits_waistband_width', '$suits_pants_cuff', '$suits_pants_cuff_width', '$suits_belt', '$suits_pants_lining_style', '$suits_embroidery_waist_initial_or_name', '$suits_embroidery_waist_color', '$suits_embroidery_waist_design', '$suits_embroidery_cuffs_initial_or_name', '$suits_embroidery_cuffs_color', '$suits_embroidery_cuffs_design', '$suits_pants_brand', '$suits_coin_pocket_inside', '$suits_suspender_buttons_inside', '$suits_split_tabs_back', '$suits_tuxedo_satin', '$suits_tuxedo_satin_waist_band', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query16 = mysql_query($sql16) or die("Can't Query16");
...
$sql16 = " INSERT INTO customize_suits_design (id, order_id, product_id, suits_customer_name, suits_order_no, suits_order_date, suits_delivery_date, suits_fabric_no, suits_lining_no, suits_jacket_style, suits_lapel_style, suits_lapel_width, suits_lapel_move, suits_lapel_color, suits_real_lapel_boutonniere, suits_vent_style, suits_pocket_style, suits_chest_pocket, suits_shoulder_construction, suits_sleeve_button, suits_cuff, suits_all_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_color, suits_contrast_last_sleevebutton_holes_button, suits_lining_style, suits_canvas, suits_jacket_button_number, suits_jacket_thread_on_button, suits_jacket_button_hole_color, suits_pick_stitch, suits_pick_stitch_lapel_color, suits_pick_stitch_pocket_color, suits_pick_stitch_sleeves, suits_pick_stitch_vest, suits_embroidery_inside_initial_or_name, suits_embroidery_inside_color, suits_embroidery_inside_design, suits_embroidery_collar_initial_or_name, suits_embroidery_collar_color, suits_embroidery_collar_design, suits_brand, suits_elbow_patch, suits_collar_felt_color, suits_front_pleat, suits_front_pocket, suits_back_pocket, suits_no_back_pocket, suits_pants_back_button_number, suits_pants_button_number, suits_pants_thread_on_button, suits_pants_button_hole_color, suits_fastening, suits_fly_option, suits_fly_option_zip, suits_band_edge_style, suits_very_extended_waistband, suits_waistband_width, suits_pants_cuff, suits_pants_cuff_width, suits_belt, suits_pants_lining_style, suits_embroidery_waist_initial_or_name, suits_embroidery_waist_color, suits_embroidery_waist_design, suits_embroidery_cuffs_initial_or_name, suits_embroidery_cuffs_color, suits_embroidery_cuffs_design, suits_pants_brand, suits_coin_pocket_inside, suits_suspender_buttons_inside, suits_split_tabs_back, suits_tuxedo_satin, suits_tuxedo_satin_waist_band, suits_date, suits_time, suits_ip, suits_status) VALUES ('$id_suits', '$order_id', '$product_id', '$suits_customer_name', '$suits_order_no', '$suits_order_date', '$suits_delivery_date', '$suits_fabric_no_6', '$suits_lining_no_6', '$suits_jacket_style', '$suits_lapel_style', '$suits_lapel_width', '$suits_lapel_move', '$suits_lapel_color', '$suits_real_lapel_boutonniere', '$suits_vent_style', '$suits_pocket_style', '$suits_chest_pocket', '$suits_shoulder_construction', '$suits_sleeve_button', '$suits_cuff', '$suits_all_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_color', '$suits_contrast_last_sleevebutton_holes_button', '$suits_lining_style', '$suits_canvas', '$suits_jacket_button_number', '$suits_jacket_thread_on_button', '$suits_jacket_button_hole_color', '$suits_pick_stitch', '$suits_pick_stitch_lapel_color', '$suits_pick_stitch_pocket_color', '$suits_pick_stitch_sleeves', '$suits_pick_stitch_vest', '$suits_embroidery_inside_initial_or_name', '$suits_embroidery_inside_color', '$suits_embroidery_inside_design', '$suits_embroidery_collar_initial_or_name', '$suits_embroidery_collar_color', '$suits_embroidery_collar_design', '$suits_brand', '$suits_elbow_patch', '$suits_collar_felt_color', '$suits_front_pleat', '$suits_front_pocket', '$suits_back_pocket', '$suits_no_back_pocket', '$suits_pants_back_button_number', '$suits_pants_button_number', '$suits_pants_thread_on_button', '$suits_pants_button_hole_color', '$suits_fastening', '$suits_fly_option', '$suits_fly_option_zip', '$suits_band_edge_style', '$suits_very_extended_waistband', '$suits_waistband_width', '$suits_pants_cuff', '$suits_pants_cuff_width', '$suits_belt', '$suits_pants_lining_style', '$suits_embroidery_waist_initial_or_name', '$suits_embroidery_waist_color', '$suits_embroidery_waist_design', '$suits_embroidery_cuffs_initial_or_name', '$suits_embroidery_cuffs_color', '$suits_embroidery_cuffs_design', '$suits_pants_brand', '$suits_coin_pocket_inside', '$suits_suspender_buttons_inside', '$suits_split_tabs_back', '$suits_tuxedo_satin', '$suits_tuxedo_satin_waist_band', '$suits_date', '$suits_time', '$suits_ip', '$suits_status') ";
$query16 = mysql_query($sql16) or die("Can't Query16");
