...
$tuxedo_with_vest_jacket_measurement_waist_upper = $row1["tuxedo_with_vest_jacket_measurement_waist_upper"];
$tuxedo_with_vest_jacket_measurement_waist_lower = $row1["tuxedo_with_vest_jacket_measurement_waist_lower"];
...
$tuxedo_with_vest_vest_measurement_waist_upper = $row1["tuxedo_with_vest_vest_measurement_waist_upper"];
$tuxedo_with_vest_vest_measurement_waist_lower = $row1["tuxedo_with_vest_vest_measurement_waist_lower"];
...
/*CUSTOMIZE*/
$tuxedo_with_vest_tuxedo_style = $row1["tuxedo_with_vest_tuxedo_style"];
...
$tuxedo_with_vest_lapel_move = $row1["tuxedo_with_vest_lapel_move"];
...
$tuxedo_with_vest_jacket_measurement_waist_upper = $row2["tuxedo_with_vest_jacket_measurement_waist_upper"];
$tuxedo_with_vest_jacket_measurement_waist_lower = $row2["tuxedo_with_vest_jacket_measurement_waist_lower"];
...
$tuxedo_with_vest_pants_measurement_cuffs_ankle = $row2["tuxedo_with_vest_pants_measurement_cuffs_ankle"];
$tuxedo_with_vest_pants_measurement_length_outleg = $row2["tuxedo_with_vest_pants_measurement_length_outleg"];
$tuxedo_with_vest_pants_measurement_only_crotch = $row2["tuxedo_with_vest_pants_measurement_only_crotch"];
...
$tuxedo_with_vest_vest_measurement_waist_upper = $row2["tuxedo_with_vest_vest_measurement_waist_upper"];
$tuxedo_with_vest_vest_measurement_waist_lower = $row2["tuxedo_with_vest_vest_measurement_waist_lower"];
$tuxedo_with_vest_vest_measurement_hips = $row2["tuxedo_with_vest_vest_measurement_hips"];
$tuxedo_with_vest_vest_measurement_shoulders = $row2["tuxedo_with_vest_vest_measurement_shoulders"];
$tuxedo_with_vest_vest_measurement_sleeves_right = $row2["tuxedo_with_vest_vest_measurement_sleeves_right"];
$tuxedo_with_vest_vest_measurement_sleeves_left = $row2["tuxedo_with_vest_vest_measurement_sleeves_left"];
...
$tuxedo_with_vest_vest_measurement_biceps = $row2["tuxedo_with_vest_vest_measurement_biceps"];
...
$tuxedo_with_vest_remark = $row2["tuxedo_with_vest_remark"];
...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$tuxedo_with_vest_order_no', '$tuxedo_with_vest_customer_name', '$tuxedo_with_vest_price_1', '$order_product', '$tuxedo_with_vest_fabric_no_1', '$tuxedo_with_vest_date', '$tuxedo_with_vest_time', '$tuxedo_with_vest_ip', '$tuxedo_with_vest_status') ";
