...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$vest_order_no', '$vest_customer_name', '$vest_price_2', '$order_product', '$vest_fabric_no_2', '$vest_date', '$vest_time', '$vest_ip', '$vest_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$vest_order_no', '$vest_customer_name', '$vest_price_3', '$order_product', '$vest_fabric_no_3', '$vest_date', '$vest_time', '$vest_ip', '$vest_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$vest_order_no', '$vest_customer_name', '$vest_price_4', '$order_product', '$vest_fabric_no_4', '$vest_date', '$vest_time', '$vest_ip', '$vest_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$vest_order_no', '$vest_customer_name', '$vest_price_5', '$order_product', '$vest_fabric_no_5', '$vest_date', '$vest_time', '$vest_ip', '$vest_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$vest_order_no', '$vest_customer_name', '$vest_price_6', '$order_product', '$vest_fabric_no_6', '$vest_date', '$vest_time', '$vest_ip', '$vest_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
