...
$sql5 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$suits_with_vest_order_no', order_price = '$suits_with_vest_price_1', order_product = '$order_product', order_fabric_no = '$suits_with_vest_fabric_no_1', order_date = '$suits_with_vest_date', order_time = '$suits_with_vest_time', order_ip = '$suits_with_vest_ip', order_status = '$suits_with_vest_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
