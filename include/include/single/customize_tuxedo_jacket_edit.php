...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$tuxedo_jacket_order_no', order_price = '$tuxedo_jacket_price_1', order_product = '$order_product', order_fabric_no = '$tuxedo_jacket_fabric_no_1', order_date = '$tuxedo_jacket_date', order_time = '$tuxedo_jacket_time', order_ip = '$tuxedo_jacket_ip', order_status = '$tuxedo_jacket_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
