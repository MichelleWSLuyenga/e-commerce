...
$tuxedo_jacket_jacket_measurement_waist_upper = $row1["tuxedo_jacket_jacket_measurement_waist_upper"];
$tuxedo_jacket_jacket_measurement_waist_lower = $row1["tuxedo_jacket_jacket_measurement_waist_lower"];
...
/*CUSTOMIZE*/
$tuxedo_jacket_tuxedo_style = $row1["tuxedo_jacket_tuxedo_style"];
...
$tuxedo_jacket_lapel_move = $row1["tuxedo_jacket_lapel_move"];
...
$tuxedo_jacket_jacket_measurement_waist_upper = $row2["tuxedo_jacket_jacket_measurement_waist_upper"];
$tuxedo_jacket_jacket_measurement_waist_lower = $row2["tuxedo_jacket_jacket_measurement_waist_lower"];
...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$tuxedo_jacket_order_no', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_price_1', '$order_product', '$tuxedo_jacket_fabric_no_1', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
