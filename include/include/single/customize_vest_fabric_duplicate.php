...
$vest_vest_measurement_waist_upper = $row1["vest_vest_measurement_waist_upper"];
$vest_vest_measurement_waist_lower = $row1["vest_vest_measurement_waist_lower"];
...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$vest_order_no', '$vest_customer_name', '$vest_price_1', '$order_product', '$vest_fabric_no_1', '$vest_date', '$vest_time', '$vest_ip', '$vest_status') ";
