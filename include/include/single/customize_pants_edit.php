...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$pants_order_no', order_price = '$pants_price_1', order_product = '$order_product', order_fabric_no = '$pants_fabric_no_1', order_date = '$pants_date', order_time = '$pants_time', order_ip = '$pants_ip', order_status = '$pants_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
$query3 = mysql_query($sql3) or die("Can't Query3");

$sql4 = " UPDATE customize_pants_design SET pants_customer_name = '$pants_customer_name', pants_order_no = '$pants_order_no', pants_order_date = '$pants_order_date', pants_delivery_date = '$pants_delivery_date', pants_fabric_no = '$pants_fabric_no_1', pants_lining_no = '$pants_lining_no_1', pants_front_pleat = '$pants_front_pleat', pants_front_pocket = '$pants_front_pocket', pants_back_pocket = '$pants_back_pocket', pants_no_back_pocket = '$pants_no_back_pocket', pants_pants_button_number = '$pants_pants_button_number', pants_pants_back_button_number = '$pants_pants_back_button_number', pants_pants_thread_on_button = '$pants_pants_thread_on_button', pants_pants_button_hole_color = '$pants_pants_button_hole_color', pants_fastening = '$pants_fastening', pants_fly_option = '$pants_fly_option', pants_band_edge_style = '$pants_band_edge_style', pants_very_extended_waistband = '$pants_very_extended_waistband', pants_waistband_width = '$pants_waistband_width', pants_cuff = '$pants_cuff', pants_cuff_width = '$pants_cuff_width', pants_belt = '$pants_belt', pants_pants_lining_style = '$pants_pants_lining_style', pants_embroidery_waist_initial_or_name = '$pants_embroidery_waist_initial_or_name', pants_embroidery_waist_color = '$pants_embroidery_waist_color', pants_embroidery_waist_design = '$pants_embroidery_waist_design', pants_embroidery_cuffs_initial_or_name = '$pants_embroidery_cuffs_initial_or_name', pants_embroidery_cuffs_color = '$pants_embroidery_cuffs_color', pants_embroidery_cuffs_design = '$pants_embroidery_cuffs_design', pants_pants_brand = '$pants_pants_brand', pants_coin_pocket_inside = '$pants_coin_pocket_inside', pants_suspender_buttons_inside = '$pants_suspender_buttons_inside', pants_split_tabs_back = '$pants_split_tabs_back', pants_tuxedo_satin = '$pants_tuxedo_satin', pants_tuxedo_satin_waist_band = '$pants_tuxedo_satin_waist_band', pants_date = '$pants_date', pants_time = '$pants_time', pants_ip = '$pants_ip', pants_status = '$pants_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
