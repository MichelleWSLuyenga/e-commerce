...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$jacket_order_no', '$jacket_customer_name', '$jacket_price_2', '$order_product', '$jacket_fabric_no_2', '$jacket_date', '$jacket_time', '$jacket_ip', '$jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$jacket_order_no', '$jacket_customer_name', '$jacket_price_3', '$order_product', '$jacket_fabric_no_3', '$jacket_date', '$jacket_time', '$jacket_ip', '$jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$jacket_order_no', '$jacket_customer_name', '$jacket_price_4', '$order_product', '$jacket_fabric_no_4', '$jacket_date', '$jacket_time', '$jacket_ip', '$jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$jacket_order_no', '$jacket_customer_name', '$jacket_price_5', '$order_product', '$jacket_fabric_no_5', '$jacket_date', '$jacket_time', '$jacket_ip', '$jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$jacket_order_no', '$jacket_customer_name', '$jacket_price_6', '$order_product', '$jacket_fabric_no_6', '$jacket_date', '$jacket_time', '$jacket_ip', '$jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
