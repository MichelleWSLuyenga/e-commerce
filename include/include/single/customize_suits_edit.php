...
$sql4 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$suits_order_no', order_price = '$suits_price_1', order_product = '$order_product', order_fabric_no = '$suits_fabric_no_1', order_date = '$suits_date', order_time = '$suits_time', order_ip = '$suits_ip', order_status = '$suits_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
