...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$jeans_order_no', order_price = '$jeans_price_1', order_product = '$order_product', order_fabric_no = '$jeans_fabric_no_1', order_date = '$jeans_date', order_time = '$jeans_time', order_ip = '$jeans_ip', order_status = '$jeans_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
