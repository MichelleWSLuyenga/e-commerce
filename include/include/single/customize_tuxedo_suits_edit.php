...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$tuxedo_suits_order_no', order_price = '$tuxedo_suits_price_1', order_product = '$order_product', order_fabric_no = '$tuxedo_suits_fabric_no_1', order_date = '$tuxedo_suits_date', order_time = '$tuxedo_suits_time', order_ip = '$tuxedo_suits_ip', order_status = '$tuxedo_suits_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
