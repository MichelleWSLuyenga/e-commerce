...
$overcoat_overcoat_measurement_waist_upper = $row1["overcoat_overcoat_measurement_waist_upper"];
$overcoat_overcoat_measurement_waist_lower = $row1["overcoat_overcoat_measurement_waist_lower"];
...
$overcoat_overcoat_measurement_waist_upper = $row2["overcoat_overcoat_measurement_waist_upper"];
$overcoat_overcoat_measurement_waist_lower = $row2["overcoat_overcoat_measurement_waist_lower"];
...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$overcoat_order_no', '$overcoat_customer_name', '$overcoat_price_1', '$order_product', '$overcoat_fabric_no_1', '$overcoat_date', '$overcoat_time', '$overcoat_ip', '$overcoat_status') ";
