...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$order_price', '$order_product', '$ties_fabric_no', '$ties_date', '$ties_time', '$ties_ip', '$ties_status') ";
