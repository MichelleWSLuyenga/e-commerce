...
if ($suits_with_vest_orderid != "") {
	...
	$sql23 = " UPDATE customize_checkout SET checkout_company = '$company_user', checkout_order = '$suits_with_vest_order_no', checkout_date = '$suits_with_vest_date', checkout_time = '$suits_with_vest_time', checkout_ip = '$suits_with_vest_ip', checkout_status = '$suits_with_vest_status' WHERE checkout_orderid = '$order_id' ";
	$query23 = mysql_query($sql23) or die("Can't Query23");
	
} else if ($suits_with_vest_orderid == "") {
	
	$sql23 = " INSERT INTO customize_checkout (id, checkout_company, checkout_order, checkout_orderid, checkout_date, checkout_time, checkout_ip, checkout_status) VALUES ('$id_customize_checkout', '$company_user', '$suits_with_vest_order_no', '$order_id', '$suits_with_vest_date', '$suits_with_vest_time', '$suits_with_vest_ip', '$suits_with_vest_status') ";
	$query23 = mysql_query($sql23) or die("Can't Query23");
