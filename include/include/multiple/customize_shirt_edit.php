...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_price = '$shirt_price_1', order_product = '$order_product', order_fabric_no = '$shirt_fabric_no_1', order_date = '$shirt_date', order_time = '$shirt_time', order_ip = '$shirt_ip', order_status = '$shirt_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
