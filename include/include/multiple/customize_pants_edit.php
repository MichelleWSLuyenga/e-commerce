...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_price = '$pants_price_1', order_product = '$order_product', order_fabric_no = '$pants_fabric_no_1', order_date = '$pants_date', order_time = '$pants_time', order_ip = '$pants_ip', order_status = '$pants_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
