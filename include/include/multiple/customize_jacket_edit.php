...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_price = '$jacket_price_1', order_product = '$order_product', order_fabric_no = '$jacket_fabric_no_1', order_date = '$jacket_date', order_time = '$jacket_time', order_ip = '$jacket_ip', order_status = '$jacket_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
