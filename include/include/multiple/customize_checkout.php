...
$sql15 = " UPDATE customize_checkout SET checkout_status_process = '$checkout_status_process', checkout_status_payment = '$checkout_status_payment' WHERE checkout_orderid = '$checkout_orderid' ";
...
if($query19) {
	...
	echo " <script language='javascript'> window.location='../../../history/multiple/'; </script> ";
