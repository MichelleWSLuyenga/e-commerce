...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$order_price', '$order_product', '$suits_with_vest_fabric_no', '$suits_with_vest_date', '$suits_with_vest_time', '$suits_with_vest_ip', '$suits_with_vest_status') ";
