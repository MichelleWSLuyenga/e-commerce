...
$jacket_measurement_remark = $_POST["item_measurement_remark"];

$jacket_jacket_tailor_allowance = $_POST["jacket_jacket_tailor_allowance"];


if($jacket_jacket_tailor_allowance == 'Body Measurement'){
	$jacket_jacket_measurement_fit = $_POST["jacket_jacket_measurement_fit"];
}
else{

	$jacket_jacket_measurement_fit = "";
}



$jacket_jacket_measurement_upper_wrist = $_POST["jacket_jacket_measurement_upper_wrist"];
$jacket_jacket_measurement_lower_wrist = $_POST["jacket_jacket_measurement_lower_wrist"];
...
$jeans_measurement_remark = $_POST["item_measurement_remark"];
...
$overcoat_measurement_remark = $_POST["item_measurement_remark"];
...
$pants_measurement_remark = $_POST["item_measurement_remark"];

$pants_pants_tailor_allowance = $_POST["pants_pants_tailor_allowance"];

if($pants_pants_tailor_allowance == 'Body Measurement'){
...
$shirt_measurement_remark = $_POST["item_measurement_remark"];

$shirt_shirt_tailor_allowance = $_POST["shirt_shirt_tailor_allowance"];
if($shirt_shirt_tailor_allowance == 'Body Measurement'){
	$shirt_measurement_fit = $_POST["shirt_measurement_fit"];
}
else{
	   $shirt_measurement_fit = "";
}
...
$suits_jacket_measurement_waist_only = $_POST["jacket_jacket_measurement_waist_only"];
...
$suits_measurement_remark = $_POST["item_measurement_remark"];
...
$suits_with_vest_jacket_measurement_waist_only = $_POST["jacket_jacket_measurement_waist_only"];
...
$suits_with_vest_vest_measurement_waist_only = $_POST["vest_vest_measurement_waist_only"];
...
$suits_with_vest_measurement_remark = $_POST["item_measurement_remark"];
...
$tuxedo_jacket_jacket_measurement_waist_only = $_POST["jacket_jacket_measurement_waist_only"];
...
$tuxedo_jacket_measurement_remark = $_POST["item_measurement_remark"];
...
$tuxedo_suits_jacket_measurement_waist_only = $_POST["jacket_jacket_measurement_waist_only"];
...
$tuxedo_suits_measurement_remark = $_POST["item_measurement_remark"];
...
$tuxedo_with_vest_jacket_measurement_waist_only = $_POST["jacket_jacket_measurement_waist_only"];
...
$tuxedo_with_vest_vest_measurement_waist_only = $_POST["vest_vest_measurement_waist_only"];
...
$tuxedo_with_vest_measurement_remark = $_POST["item_measurement_remark"];
...
$vest_measurement_remark = $_POST["item_measurement_remark"];


$vest_vest_tailor_allowance = $_POST["vest_vest_tailor_allowance"];

if($vest_vest_tailor_allowance == 'Body Measurement'){
	$vest_vest_measurement_fit = $_POST["vest_vest_measurement_fit"];
}
else{

	$vest_vest_measurement_fit = "";
}
...
$sql10 = " UPDATE customize_shirt_measurements SET shirt_shirt_tailor_allowance ='$shirt_shirt_tailor_allowance', shirt_measurement_sex = '$shirt_measurement_sex', shirt_measurement_sleeves = '$shirt_measurement_sleeves', shirt_measurement_fit = '$shirt_measurement_fit', shirt_measurement = '$shirt_measurement', shirt_measurement_shirt_length = '$shirt_measurement_shirt_length', shirt_measurement_chest = '$shirt_measurement_chest', shirt_measurement_waist_only = '$shirt_measurement_waist_only', shirt_measurement_hips = '$shirt_measurement_hips', shirt_measurement_shoulders = '$shirt_measurement_shoulders', shirt_measurement_sleeves_right = '$shirt_measurement_sleeves_right', shirt_measurement_sleeves_left = '$shirt_measurement_sleeves_left', shirt_measurement_neck = '$shirt_measurement_neck', shirt_measurement_biceps = '$shirt_measurement_biceps', shirt_measurement_back_length = '$shirt_measurement_back_length', shirt_measurement_forearm = '$shirt_measurement_forearm', shirt_measurement_cuff_right = '$shirt_measurement_cuff_right', shirt_measurement_cuff_left = '$shirt_measurement_cuff_left', shirt_measurement_arm_hole = '$shirt_measurement_arm_hole', shirt_measurement_shoulder = '$shirt_measurement_shoulder', shirt_measurement_waist = '$shirt_measurement_waist', shirt_measurement_chest_body = '$shirt_measurement_chest_body', shirt_measurement_remark = '$shirt_measurement_remark', shirt_ip = '$shirt_ip' WHERE order_id = '$order_id' AND shirt_status = '$shirt_status' ";
...
$sql67 = " UPDATE customize_checkout SET checkout_order = '$jacket_order_no', checkout_customer = '$jacket_customer_name' WHERE checkout_orderid = '$order_id' ";
$query67 = mysql_query($sql67) or die("Can't Query67");

if($query67) {
	
	echo " <script language='javascript'> window.location='../../../checkout/single/index.php?orderid=".$order_id."'; </script> ";
