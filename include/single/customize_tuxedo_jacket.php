...
$sqlmy4 = " SELECT * FROM admin_fabrics_tuxedo_jacket WHERE fabricno = '$tuxedo_jacket_fabric_no_1' ";
...
$sqlmy5 =	" SELECT * FROM admin_fabrics_tuxedo_jacket WHERE fabricno = '$tuxedo_jacket_fabric_no_2' ";
...
$rowmymy03 = mysql_fetch_array($querymy03);


$tuxedo_jacket_fabric_my_price_2 = $rowmy03["0"];
...
$tuxedo_jacket_fabric_my_price_2 = $rowmy04["0"];
	
}

$sqlmy6 = " SELECT * FROM admin_fabrics_tuxedo_jacket WHERE fabricno = '$tuxedo_jacket_fabric_no_3' ";
...
$tuxedo_jacket_fabric_my_price_3 = $rowmy05["0"];
...
$tuxedo_jacket_fabric_my_price_3 = $rowmy06["0"];
	
}

$sqlmy7 = " SELECT * FROM admin_fabrics_tuxedo_jacket WHERE fabricno = '$tuxedo_jacket_fabric_no_4' ";
...
$tuxedo_jacket_fabric_my_price_4 = $rowmy07["0"];
...
$sqlmy008 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Jacket' ";
$querymy008 = mysql_db_query($dbname, $sqlmy08) or die("Can't Querymy08");
$rowmy008 = mysql_fetch_array($querymy008);	


$tuxedo_jacket_fabric_my_price_4 = $rowmy08["0"];
	
}

$sqlmy8 = " SELECT * FROM admin_fabrics_tuxedo_jacket WHERE fabricno = '$tuxedo_jacket_fabric_no_5' ";
...
$sqlmy009 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Jacket' ";
$querymy009 = mysql_db_query($dbname, $sqlmy009) or die("Can't Querymy009");
$rowmy009 = mysql_fetch_array($querymy009);


$tuxedo_jacket_fabric_my_price_5 = $rowmy09["0"];
...
$sqlmy0010 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Jacket' ";
$querymy0010 = mysql_db_query($dbname, $sqlmy0010) or die("Can't Querymy0010");
$rowmy0010 = mysql_fetch_array($querymy0010);	


$tuxedo_jacket_fabric_my_price_5 = $rowmy010["0"];
	
}

$sqlmy9 = " SELECT * FROM admin_fabrics_tuxedo_jacket WHERE fabricno = '$tuxedo_jacket_fabric_no_6' ";
...
$sqlmy0011 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Jacket' ";
$querymy0011 = mysql_db_query($dbname, $sqlmy0011) or die("Can't Querymy0011");
$rowmy0011 = mysql_fetch_array($querymy0011);



$tuxedo_jacket_fabric_my_price_6 = $rowmy011["0"];
...
$sqlmy0012 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Jacket' ";
$querymy0012 = mysql_db_query($dbname, $sqlmy0012) or die("Can't Querymy0012");
$rowmy0012 = mysql_fetch_array($querymy0012);	



$tuxedo_jacket_fabric_my_price_6 = $rowmy012["0"];
...
if (($tuxedo_jacket_jacket_measurement_chest >= '50' && $tuxedo_jacket_jacket_measurement_chest <= '52') || ($tuxedo_jacket_jacket_measurement_waist_only >= '50' && $tuxedo_jacket_jacket_measurement_waist_only <= '52') || ($tuxedo_jacket_jacket_measurement_hips >= '50' && $tuxedo_jacket_jacket_measurement_hips <= '52')) {
	...
	$price_my_size_4 = $tuxedo_jacket_fabric_my_price_2 * 20;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $tuxedo_jacket_fabric_my_price_2;
	
	$price_my_size_7 = $tuxedo_jacket_fabric_my_price_3 * 20;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_size_8 + $tuxedo_jacket_fabric_my_price_3;
	
	$price_my_size_10 = $tuxedo_jacket_fabric_my_price_4 * 20;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $tuxedo_jacket_fabric_my_price_4;
	
	$price_my_size_13 = $tuxedo_jacket_fabric_my_price_5 * 20;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $tuxedo_jacket_fabric_my_price_5;
	
	$price_my_size_16 = $tuxedo_jacket_fabric_my_price_6 * 20;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $tuxedo_jacket_fabric_my_price_6;
	
} else if (($tuxedo_jacket_jacket_measurement_chest >= '52.5' && $tuxedo_jacket_jacket_measurement_chest <= '56') || ($tuxedo_jacket_jacket_measurement_waist_only >= '52.5' && $tuxedo_jacket_jacket_measurement_waist_only <= '56') || ($tuxedo_jacket_jacket_measurement_hips >= '52.5' && $tuxedo_jacket_jacket_measurement_hips <= '56')) {
	
	$price_my_size_1 = $tuxedo_jacket_fabri_myc_price_1 * 30;
	$price_my_size_2 = $price_my_size_1 / 100;
	$price_my_size_3 = $price_my_size_2 + $tuxedo_jacket_fabric_my_price_1;
	
	$price_my_size_4 = $tuxedo_jacket_fabric_my_price_2 * 30;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $tuxedo_jacket_fabric_my_price_2;
	
	$price_my_size_7 = $tuxedo_jacket_fabric_my_price_3 * 30;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $tuxedo_jacket_fabric_my_price_3;
	
	$price_my_size_10 = $tuxedo_jacket_fabric_my_price_4 * 30;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $tuxedo_jacket_fabric_my_price_4;
	
	$price_my_size_13 = $tuxedo_jacket_fabric_my_price_5 * 30;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $tuxedo_jacket_fabric_my_price_5;
	
	$price_my_size_16 = $tuxedo_jacket_fabric_my_price_6 * 30;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $tuxedo_jacket_fabric_my_price_6;
	...
	$price_my_size_4 = $tuxedo_jacket_fabric_my_price_2 * 40;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $tuxedo_jacket_fabric_my_price_2;
	
	$price_my_size_7 = $tuxedo_jacket_fabric_my_price_3 * 40;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $tuxedo_jacket_fabric_my_price_3;
	
	$price_my_size_10 = $tuxedo_jacket_fabric_my_price_4 * 40;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $tuxedo_jacket_fabric_my_price_4;
	
	$price_my_size_13 = $tuxedo_jacket_fabric_my_price_5 * 40;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $tuxedo_jacket_fabric_my_price_5;
	
	$price_my_size_16 = $tuxedo_jacket_fabric_my_price_6 * 40;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $tuxedo_jacket_fabric_my_price_6;
	...
	$price_my_size_4 = $tuxedo_jacket_fabric_my_price_2 * 50;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $tuxedo_jacket_fabric_my_price_2;
	
	$price_my_size_7 = $tuxedo_jacket_fabric_my_price_3 * 50;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $tuxedo_jacket_fabric_my_price_3;
	
	$price_my_size_10 = $tuxedo_jacket_fabric_my_price_4 * 50;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $tuxedo_jacket_fabric_my_price_4;
	
	$price_my_size_13 = $tuxedo_jacket_fabric_my_price_5 * 50;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $tuxedo_jacket_fabric_my_price_5;
	
	$price_my_size_16 = $tuxedo_jacket_fabric_my_price_6 * 50;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $tuxedo_jacket_fabric_my_price_6;
	...
	$price__mysize_4 = $tuxedo_jacket_fabric_my_price_2 * 60;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $tuxedo_jacket_fabric_my_price_2;
	
	$price_my_size_7 = $tuxedo_jacket_fabric_my_price_3 * 60;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $tuxedo_jacket_fabric_my_price_3;
	
	$price_my_size_10 = $tuxedo_jacket_fabric_my_price_4 * 60;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $tuxedo_jacket_fabric_my_price_4;
	
	$price_my_size_13 = $tuxedo_jacket_fabric_my_price_5 * 60;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $tuxedo_jacket_fabric_my_price_5;
	
	$price_my_size_16 = $tuxedo_jacket_fabric_my_price_6 * 60;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $tuxedo_jacket_fabric_my_price_6;
	...
	$price_my_size_6 = $tuxedo_jacket_fabric_my_price_2;
	$price_my_size_9 = $tuxedo_jacket_fabric_my_price_3;
	$price_my_size_12 = $tuxedo_jacket_fabric_my_price_4;
	$price_my_size_15 = $tuxedo_jacket_fabric_my_price_5;
	$price_my_size_18 = $tuxedo_jacket_fabric_my_price_6;
...
$query10 = mysql_db_query($dbname, $sql10) or die("Can't Query10");
$row10 = mysql_fetch_array($query10);
$tuxedo_jacket_button_my_price = $row10["price"];

$tuxedo_jacket_button_my_price_1 = $price_my_size_3 + $tuxedo_jacket_button_my_price;
$tuxedo_jacket_button_my_price_2 = $price_my_size_6 + $tuxedo_jacket_button_my_price;
$tuxedo_jacket_button_my_price_3 = $price_my_size_9 + $tuxedo_jacket_button_my_price;
$tuxedo_jacket_button_my_price_4 = $price_my_size_12 + $tuxedo_jacket_button_my_price;
$tuxedo_jacket_button_my_price_5 = $price_my_size_15 + $tuxedo_jacket_button_my_price;
$tuxedo_jacket_button_my_price_6 = $price_my_size_18 + $tuxedo_jacket_button_my_price;
...
$tuxedo_jacket_my_price_2 = $tuxedo_jacket_button_my_price_2 + $tuxedo_jacket_embroidery_collar_initial_or_name_my_price + $tuxedo_jacket_brand_my_price + $tuxedo_jacket_pick_stitch_sleeves_my_price + $tuxedo_jacket_pick_stitch_vest_my_price + $tuxedo_jacket_elbow_patch_my_price + $tuxedo_jacket_canvas_my_price + $tuxedo_jacket_chest_pocket_satin_fabric_my_price + $tuxedo_jacket_lower_pocket_satin_fabric_my_price;

$tuxedo_jacket_my_price_3 = $tuxedo_jacket_button_my_price_3 + $tuxedo_jacket_embroidery_collar_initial_or_name_my_price + $tuxedo_jacket_brand_my_price + $tuxedo_jacket_pick_stitch_sleeves_my_price + $tuxedo_jacket_pick_stitch_vest_my_price + $tuxedo_jacket_elbow_patch_my_price + $tuxedo_jacket_canvas_my_price + $tuxedo_jacket_chest_pocket_satin_fabric_my_price + $tuxedo_jacket_lower_pocket_satin_fabric_my_price;

$tuxedo_jacket_my_price_4 = $tuxedo_jacket_button_my_price_4 + $tuxedo_jacket_embroidery_collar_initial_or_name_my_price + $tuxedo_jacket_brand_my_price + $tuxedo_jacket_pick_stitch_sleeves_my_price + $tuxedo_jacket_pick_stitch_vest_my_price + $tuxedo_jacket_elbow_patch_my_price + $tuxedo_jacket_canvas_my_price + $tuxedo_jacket_chest_pocket_satin_fabric_my_price + $tuxedo_jacket_lower_pocket_satin_fabric_my_price;

$tuxedo_jacket_my_price_5 = $tuxedo_jacket_button_my_price_5 + $tuxedo_jacket_embroidery_collar_initial_or_name_my_price + $tuxedo_jacket_brand_my_price + $tuxedo_jacket_pick_stitch_sleeves_my_price + $tuxedo_jacket_pick_stitch_vest_my_price + $tuxedo_jacket_elbow_patch_my_price + $tuxedo_jacket_canvas_my_price + $tuxedo_jacket_chest_pocket_satin_fabric_my_price + $tuxedo_jacket_lower_pocket_satin_fabric_my_price;

$tuxedo_jacket_my_price_6 = $tuxedo_jacket_button_my_price_6 + $tuxedo_jacket_embroidery_collar_initial_or_name_my_price + $tuxedo_jacket_brand_my_price + $tuxedo_jacket_pick_stitch_sleeves_my_price + $tuxedo_jacket_pick_stitch_vest_my_price + $tuxedo_jacket_elbow_patch_my_price + $tuxedo_jacket_canvas_my_price + $tuxedo_jacket_chest_pocket_satin_fabric_my_price + $tuxedo_jacket_lower_pocket_satin_fabric_my_price;
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$tuxedo_jacket_order_no', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_my_price_2', '$tuxedo_jacket_price_2', '$order_product', '$tuxedo_jacket_fabric_no_2', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");

$sql15 = " INSERT INTO customize_tuxedo_jacket_design (id, order_id, product_id, tuxedo_jacket_customer_name, tuxedo_jacket_order_no, tuxedo_jacket_order_date, tuxedo_jacket_delivery_date, tuxedo_jacket_fabric_no, tuxedo_jacket_lining_no, tuxedo_jacket_jacket_style, tuxedo_jacket_satin_style, tuxedo_jacket_collar_satin_style, tuxedo_jacket_lapel_satin_style, tuxedo_jacket_half_satin_option, tuxedo_jacket_lapel_style, tuxedo_jacket_lapel_width, tuxedo_jacket_lapel_color, tuxedo_jacket_real_lapel_boutonniere, tuxedo_jacket_vent_style, tuxedo_jacket_pocket_style, tuxedo_jacket_chest_pocket, tuxedo_jacket_chest_pocket_satin, tuxedo_jacket_chest_pocket_satin_color, tuxedo_jacket_chest_pocket_satin_fabric, tuxedo_jacket_lower_pocket_satin, tuxedo_jacket_lower_pocket_satin_color, tuxedo_jacket_lower_pocket_satin_fabric, tuxedo_jacket_shoulder_construction, tuxedo_jacket_sleeve_button, tuxedo_jacket_cuff, tuxedo_jacket_all_sleevebutton_holes_color, tuxedo_jacket_contrast_last_sleevebutton_holes_color, tuxedo_jacket_contrast_last_sleevebutton_holes_button, tuxedo_jacket_lining_style, tuxedo_jacket_canvas, tuxedo_jacket_jacket_button_number, tuxedo_jacket_jacket_thread_on_button, tuxedo_jacket_jacket_button_hole_color, tuxedo_jacket_pick_stitch, tuxedo_jacket_pick_stitch_lapel_color, tuxedo_jacket_pick_stitch_pocket_color, tuxedo_jacket_pick_stitch_sleeves, tuxedo_jacket_pick_stitch_vest, tuxedo_jacket_embroidery_inside_initial_or_name, tuxedo_jacket_embroidery_inside_color, tuxedo_jacket_embroidery_inside_design, tuxedo_jacket_embroidery_collar_initial_or_name, tuxedo_jacket_embroidery_collar_color, tuxedo_jacket_embroidery_collar_design, tuxedo_jacket_brand, tuxedo_jacket_elbow_patch, tuxedo_jacket_collar_felt_color, tuxedo_jacket_date, tuxedo_jacket_time, tuxedo_jacket_ip, tuxedo_jacket_status) VALUES ('$id_tuxedo_jacket', '$order_id', '$product_id', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_order_no', '$tuxedo_jacket_order_date', '$tuxedo_jacket_delivery_date', '$tuxedo_jacket_fabric_no_2', '$tuxedo_jacket_lining_no_2', '$tuxedo_jacket_jacket_style', '$tuxedo_jacket_satin_style', '$tuxedo_jacket_collar_satin_style', '$tuxedo_jacket_lapel_satin_style', '$tuxedo_jacket_half_satin_option', '$tuxedo_jacket_lapel_style', '$tuxedo_jacket_lapel_width', '$tuxedo_jacket_lapel_color', '$tuxedo_jacket_real_lapel_boutonniere', '$tuxedo_jacket_vent_style', '$tuxedo_jacket_pocket_style', '$tuxedo_jacket_chest_pocket', '$tuxedo_jacket_chest_pocket_satin', '$tuxedo_jacket_chest_pocket_satin_color', '$tuxedo_jacket_chest_pocket_satin_fabric', '$tuxedo_jacket_lower_pocket_satin', '$tuxedo_jacket_lower_pocket_satin_color', '$tuxedo_jacket_lower_pocket_satin_fabric', '$tuxedo_jacket_shoulder_construction', '$tuxedo_jacket_sleeve_button', '$tuxedo_jacket_cuff', '$tuxedo_jacket_all_sleevebutton_holes_color', '$tuxedo_jacket_contrast_last_sleevebutton_holes_color', '$tuxedo_jacket_contrast_last_sleevebutton_holes_button', '$tuxedo_jacket_lining_style', '$tuxedo_jacket_canvas', '$tuxedo_jacket_jacket_button_number', '$tuxedo_jacket_jacket_thread_on_button', '$tuxedo_jacket_jacket_button_hole_color', '$tuxedo_jacket_pick_stitch', '$tuxedo_jacket_pick_stitch_lapel_color', '$tuxedo_jacket_pick_stitch_pocket_color', '$tuxedo_jacket_pick_stitch_sleeves', '$tuxedo_jacket_pick_stitch_vest', '$tuxedo_jacket_embroidery_inside_initial_or_name', '$tuxedo_jacket_embroidery_inside_color', '$tuxedo_jacket_embroidery_inside_design', '$tuxedo_jacket_embroidery_collar_initial_or_name', '$tuxedo_jacket_embroidery_collar_color', '$tuxedo_jacket_embroidery_collar_design', '$tuxedo_jacket_brand', '$tuxedo_jacket_elbow_patch', '$tuxedo_jacket_collar_felt_color', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$tuxedo_jacket_order_no', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_my_price_3', '$tuxedo_jacket_price_3', '$order_product', '$tuxedo_jacket_fabric_no_3', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$tuxedo_jacket_order_no', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_my_price_4', '$tuxedo_jacket_price_4', '$order_product', '$tuxedo_jacket_fabric_no_4', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");

$sql15 = " INSERT INTO customize_tuxedo_jacket_design (id, order_id, product_id, tuxedo_jacket_customer_name, tuxedo_jacket_order_no, tuxedo_jacket_order_date, tuxedo_jacket_delivery_date, tuxedo_jacket_fabric_no, tuxedo_jacket_lining_no, tuxedo_jacket_jacket_style, tuxedo_jacket_satin_style, tuxedo_jacket_collar_satin_style, tuxedo_jacket_lapel_satin_style, tuxedo_jacket_half_satin_option, tuxedo_jacket_lapel_style, tuxedo_jacket_lapel_width, tuxedo_jacket_lapel_color, tuxedo_jacket_real_lapel_boutonniere, tuxedo_jacket_vent_style, tuxedo_jacket_pocket_style, tuxedo_jacket_chest_pocket, tuxedo_jacket_chest_pocket_satin, tuxedo_jacket_chest_pocket_satin_color, tuxedo_jacket_chest_pocket_satin_fabric, tuxedo_jacket_lower_pocket_satin, tuxedo_jacket_lower_pocket_satin_color, tuxedo_jacket_lower_pocket_satin_fabric, tuxedo_jacket_shoulder_construction, tuxedo_jacket_sleeve_button, tuxedo_jacket_cuff, tuxedo_jacket_all_sleevebutton_holes_color, tuxedo_jacket_contrast_last_sleevebutton_holes_color, tuxedo_jacket_contrast_last_sleevebutton_holes_button, tuxedo_jacket_lining_style, tuxedo_jacket_canvas, tuxedo_jacket_jacket_button_number, tuxedo_jacket_jacket_thread_on_button, tuxedo_jacket_jacket_button_hole_color, tuxedo_jacket_pick_stitch, tuxedo_jacket_pick_stitch_lapel_color, tuxedo_jacket_pick_stitch_pocket_color, tuxedo_jacket_pick_stitch_sleeves, tuxedo_jacket_pick_stitch_vest, tuxedo_jacket_embroidery_inside_initial_or_name, tuxedo_jacket_embroidery_inside_color, tuxedo_jacket_embroidery_inside_design, tuxedo_jacket_embroidery_collar_initial_or_name, tuxedo_jacket_embroidery_collar_color, tuxedo_jacket_embroidery_collar_design, tuxedo_jacket_brand, tuxedo_jacket_elbow_patch, tuxedo_jacket_collar_felt_color, tuxedo_jacket_date, tuxedo_jacket_time, tuxedo_jacket_ip, tuxedo_jacket_status) VALUES ('$id_tuxedo_jacket', '$order_id', '$product_id', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_order_no', '$tuxedo_jacket_order_date', '$tuxedo_jacket_delivery_date', '$tuxedo_jacket_fabric_no_4', '$tuxedo_jacket_lining_no_4', '$tuxedo_jacket_jacket_style', '$tuxedo_jacket_satin_style', '$tuxedo_jacket_collar_satin_style', '$tuxedo_jacket_lapel_satin_style', '$tuxedo_jacket_half_satin_option', '$tuxedo_jacket_lapel_style', '$tuxedo_jacket_lapel_width', '$tuxedo_jacket_lapel_color', '$tuxedo_jacket_real_lapel_boutonniere', '$tuxedo_jacket_vent_style', '$tuxedo_jacket_pocket_style', '$tuxedo_jacket_chest_pocket', '$tuxedo_jacket_chest_pocket_satin', '$tuxedo_jacket_chest_pocket_satin_color', '$tuxedo_jacket_chest_pocket_satin_fabric', '$tuxedo_jacket_lower_pocket_satin', '$tuxedo_jacket_lower_pocket_satin_color', '$tuxedo_jacket_lower_pocket_satin_fabric', '$tuxedo_jacket_shoulder_construction', '$tuxedo_jacket_sleeve_button', '$tuxedo_jacket_cuff', '$tuxedo_jacket_all_sleevebutton_holes_color', '$tuxedo_jacket_contrast_last_sleevebutton_holes_color', '$tuxedo_jacket_contrast_last_sleevebutton_holes_button', '$tuxedo_jacket_lining_style', '$tuxedo_jacket_canvas', '$tuxedo_jacket_jacket_button_number', '$tuxedo_jacket_jacket_thread_on_button', '$tuxedo_jacket_jacket_button_hole_color', '$tuxedo_jacket_pick_stitch', '$tuxedo_jacket_pick_stitch_lapel_color', '$tuxedo_jacket_pick_stitch_pocket_color', '$tuxedo_jacket_pick_stitch_sleeves', '$tuxedo_jacket_pick_stitch_vest', '$tuxedo_jacket_embroidery_inside_initial_or_name', '$tuxedo_jacket_embroidery_inside_color', '$tuxedo_jacket_embroidery_inside_design', '$tuxedo_jacket_embroidery_collar_initial_or_name', '$tuxedo_jacket_embroidery_collar_color', '$tuxedo_jacket_embroidery_collar_design', '$tuxedo_jacket_brand', '$tuxedo_jacket_elbow_patch', '$tuxedo_jacket_collar_felt_color', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$tuxedo_jacket_order_no', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_my_price_5', '$tuxedo_jacket_price_5', '$order_product', '$tuxedo_jacket_fabric_no_5', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");

$sql15 = " INSERT INTO customize_tuxedo_jacket_design (id, order_id, product_id, tuxedo_jacket_customer_name, tuxedo_jacket_order_no, tuxedo_jacket_order_date, tuxedo_jacket_delivery_date, tuxedo_jacket_fabric_no, tuxedo_jacket_lining_no, tuxedo_jacket_jacket_style, tuxedo_jacket_satin_style, tuxedo_jacket_collar_satin_style, tuxedo_jacket_lapel_satin_style, tuxedo_jacket_half_satin_option, tuxedo_jacket_lapel_style, tuxedo_jacket_lapel_width, tuxedo_jacket_lapel_color, tuxedo_jacket_real_lapel_boutonniere, tuxedo_jacket_vent_style, tuxedo_jacket_pocket_style, tuxedo_jacket_chest_pocket, tuxedo_jacket_chest_pocket_satin, tuxedo_jacket_chest_pocket_satin_color, tuxedo_jacket_chest_pocket_satin_fabric, tuxedo_jacket_lower_pocket_satin, tuxedo_jacket_lower_pocket_satin_color, tuxedo_jacket_lower_pocket_satin_fabric, tuxedo_jacket_shoulder_construction, tuxedo_jacket_sleeve_button, tuxedo_jacket_cuff, tuxedo_jacket_all_sleevebutton_holes_color, tuxedo_jacket_contrast_last_sleevebutton_holes_color, tuxedo_jacket_contrast_last_sleevebutton_holes_button, tuxedo_jacket_lining_style, tuxedo_jacket_canvas, tuxedo_jacket_jacket_button_number, tuxedo_jacket_jacket_thread_on_button, tuxedo_jacket_jacket_button_hole_color, tuxedo_jacket_pick_stitch, tuxedo_jacket_pick_stitch_lapel_color, tuxedo_jacket_pick_stitch_pocket_color, tuxedo_jacket_pick_stitch_sleeves, tuxedo_jacket_pick_stitch_vest, tuxedo_jacket_embroidery_inside_initial_or_name, tuxedo_jacket_embroidery_inside_color, tuxedo_jacket_embroidery_inside_design, tuxedo_jacket_embroidery_collar_initial_or_name, tuxedo_jacket_embroidery_collar_color, tuxedo_jacket_embroidery_collar_design, tuxedo_jacket_brand, tuxedo_jacket_elbow_patch, tuxedo_jacket_collar_felt_color, tuxedo_jacket_date, tuxedo_jacket_time, tuxedo_jacket_ip, tuxedo_jacket_status) VALUES ('$id_tuxedo_jacket', '$order_id', '$product_id', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_order_no', '$tuxedo_jacket_order_date', '$tuxedo_jacket_delivery_date', '$tuxedo_jacket_fabric_no_5', '$tuxedo_jacket_lining_no_5', '$tuxedo_jacket_jacket_style', '$tuxedo_jacket_satin_style', '$tuxedo_jacket_collar_satin_style', '$tuxedo_jacket_lapel_satin_style', '$tuxedo_jacket_half_satin_option', '$tuxedo_jacket_lapel_style', '$tuxedo_jacket_lapel_width', '$tuxedo_jacket_lapel_color', '$tuxedo_jacket_real_lapel_boutonniere', '$tuxedo_jacket_vent_style', '$tuxedo_jacket_pocket_style', '$tuxedo_jacket_chest_pocket', '$tuxedo_jacket_chest_pocket_satin', '$tuxedo_jacket_chest_pocket_satin_color', '$tuxedo_jacket_chest_pocket_satin_fabric', '$tuxedo_jacket_lower_pocket_satin', '$tuxedo_jacket_lower_pocket_satin_color', '$tuxedo_jacket_lower_pocket_satin_fabric', '$tuxedo_jacket_shoulder_construction', '$tuxedo_jacket_sleeve_button', '$tuxedo_jacket_cuff', '$tuxedo_jacket_all_sleevebutton_holes_color', '$tuxedo_jacket_contrast_last_sleevebutton_holes_color', '$tuxedo_jacket_contrast_last_sleevebutton_holes_button', '$tuxedo_jacket_lining_style', '$tuxedo_jacket_canvas', '$tuxedo_jacket_jacket_button_number', '$tuxedo_jacket_jacket_thread_on_button', '$tuxedo_jacket_jacket_button_hole_color', '$tuxedo_jacket_pick_stitch', '$tuxedo_jacket_pick_stitch_lapel_color', '$tuxedo_jacket_pick_stitch_pocket_color', '$tuxedo_jacket_pick_stitch_sleeves', '$tuxedo_jacket_pick_stitch_vest', '$tuxedo_jacket_embroidery_inside_initial_or_name', '$tuxedo_jacket_embroidery_inside_color', '$tuxedo_jacket_embroidery_inside_design', '$tuxedo_jacket_embroidery_collar_initial_or_name', '$tuxedo_jacket_embroidery_collar_color', '$tuxedo_jacket_embroidery_collar_design', '$tuxedo_jacket_brand', '$tuxedo_jacket_elbow_patch', '$tuxedo_jacket_collar_felt_color', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query15 = mysql_query($sql15) or die("Can't Query15");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$tuxedo_jacket_order_no', '$tuxedo_jacket_customer_name', '$tuxedo_jacket_my_price_6', '$tuxedo_jacket_price_6', '$order_product', '$tuxedo_jacket_fabric_no_6', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
