...
$sqlmy1 = " SELECT * FROM admin_fabrics_suits_with_vest WHERE fabricno = '$suits_with_vest_fabric_no_1' ";
...
$query2 = mysql_db_query($dbname, $sql2) or die("Can't Query2");
$row2 = mysql_fetch_array($query2);
$suits_with_vest_jacket_button_my_price = $row2["price"];
...
$query3 = mysql_db_query($dbname, $sql3) or die("Can't Query3");
$row3 = mysql_fetch_array($query3);
$suits_with_vest_pants_button_my_price = $row3["price"];
...
$query4 = mysql_db_query($dbname, $sql4) or die("Can't Query4");
$row4 = mysql_fetch_array($query4);
$suits_with_vest_vest_button_my_price = $row4["price"];
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_with_vest_body_front_pic)){
				...
				$sql8 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_body_front = '".$suits_with_vest_body_front_pic."', suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query8 = mysql_db_query($dbname, $sql8) or die("Can't Query8");
			}
    
	} else {
				$sql8 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query8 = mysql_db_query($dbname, $sql8) or die("Can't Query8");
			}
	}
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_with_vest_body_left_pic)){
				...
				$sql9 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_body_left = '".$suits_with_vest_body_left_pic."', suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query9 = mysql_db_query($dbname, $sql9) or die("Can't Query9");
			}
    
	} else {
				$sql9 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query9 = mysql_db_query($dbname, $sql9) or die("Can't Query9");
			}
	}
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_with_vest_body_right_pic)){
				...
				$sql10 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_body_right = '".$suits_with_vest_body_right_pic."', suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query10 = mysql_db_query($dbname, $sql10) or die("Can't Query10");
			}
    
	} else {
				$sql10 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query10 = mysql_db_query($dbname, $sql10) or die("Can't Query10");
			}
	}
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_with_vest_body_back_pic)){
				...
				$sql11 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_body_back = '".$suits_with_vest_body_back_pic."', suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query11 = mysql_db_query($dbname, $sql11) or die("Can't Query11");
			}
    
	} else {
				$sql11 = " UPDATE customize_suits_with_vest_measurements SET suits_with_vest_date = '".$suits_with_vest_date."', suits_with_vest_time = '".$suits_with_vest_time."', suits_with_vest_ip = '".$suits_with_vest_ip."', suits_with_vest_status = '".$suits_with_vest_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query11 = mysql_db_query($dbname, $sql11) or die("Can't Query11");
			}
	}
