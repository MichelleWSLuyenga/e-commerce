...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$tuxedo_suits_order_no', '$tuxedo_suits_customer_name', '$order_my_price', '$order_price', '$order_product', '$tuxedo_suits_fabric_no', '$tuxedo_suits_date', '$tuxedo_suits_time', '$tuxedo_suits_ip', '$tuxedo_suits_status') ";
