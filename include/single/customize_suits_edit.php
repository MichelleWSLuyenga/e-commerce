...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_body_front_pic)){
				...
				$sql7 = " UPDATE customize_suits_measurements SET suits_body_front = '".$suits_body_front_pic."', suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query7 = mysql_db_query($dbname, $sql7) or die("Can't Query7");
			}
    
	} else {
				$sql7 = " UPDATE customize_suits_measurements SET suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query7 = mysql_db_query($dbname, $sql7) or die("Can't Query7");
			}
	}
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_body_left_pic)){
				...
				$sql8 = " UPDATE customize_suits_measurements SET suits_body_left = '".$suits_body_left_pic."', suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query8 = mysql_db_query($dbname, $sql8) or die("Can't Query8");
			}
    
	} else {
				$sql8 = " UPDATE customize_suits_measurements SET suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query8 = mysql_db_query($dbname, $sql8) or die("Can't Query8");
			}
	}
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_body_right_pic)){
				...
				$sql9 = " UPDATE customize_suits_measurements SET suits_body_right = '".$suits_body_right_pic."', suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query9 = mysql_db_query($dbname, $sql9) or die("Can't Query9");
			}
    
	} else {
				$sql9 = " UPDATE customize_suits_measurements SET suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query9 = mysql_db_query($dbname, $sql9) or die("Can't Query9");
			}
	}
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(strlen($name)){
			...
			if(move_uploaded_file($tmp, $path.$suits_body_back_pic)){
				...
				$sql10 = " UPDATE customize_suits_measurements SET suits_body_back = '".$suits_body_back_pic."', suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
				$query10 = mysql_db_query($dbname, $sql10) or die("Can't Query10");
			}
    
	} else {
				$sql10 = " UPDATE customize_suits_measurements SET suits_date = '".$suits_date."', suits_time = '".$suits_time."', suits_ip = '".$suits_ip."', suits_status = '".$suits_status."' WHERE order_id = '".$order_id."' AND product_id = '".$product_id."' ";
		   		$query10 = mysql_db_query($dbname, $sql10) or die("Can't Query10");
			}
	}
