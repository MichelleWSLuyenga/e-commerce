...
$sqlmy4 =	" SELECT * FROM admin_fabrics_overcoat WHERE fabricno = '$overcoat_fabric_no_1' ";
...
$sqlmy5 = " SELECT * FROM admin_fabrics_overcoat WHERE fabricno = '$overcoat_fabric_no_2' ";
...
$sqlmy03 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Overcoat' ";
$querymy03 = mysql_db_query($dbname, $sqlmy03) or die("Can't Querymy03");
$row03 = mysql_fetch_array($query03);
$overcoat_fabric_my_price_2 = $row03["0"];

} else if ($rowmy5["brand"] != '') {
	
$sqlmy04 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Overcoat' ";
$querymy04 = mysql_db_query($dbname, $sqlmy04) or die("Can't Querymy04");
$rowmy04 = mysql_fetch_array($querymy04);	
$overcoat_fabric_my_price_2 = $rowmy04["0"];
	
}

$sqlmy6 = " SELECT * FROM admin_fabrics_overcoat WHERE fabricno = '$overcoat_fabric_no_3' ";
...
$sqlmy05 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Overcoat' ";
$querymy05 = mysql_db_query($dbname, $sqlmy05) or die("Can't Querymy05");
$rowmy05 = mysql_fetch_array($querymy05);
$overcoat_fabric_my_price_3 = $rowmy05["0"];

} else if ($rowmy6["brand"] != '') {
	
$sqlmy06 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Overcoat' ";
$querymy06 = mysql_db_query($dbname, $sqlmy06) or die("Can't Querymy06");
$rowmy06 = mysql_fetch_array($querymy06);	
$overcoat_fabric_my_price_3 = $rowmy06["0"];
	
}

$sqlmy7 =	" SELECT * FROM admin_fabrics_overcoat WHERE fabricno = '$overcoat_fabric_no_4' ";
...
$sqlmy07 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Overcoat' ";
$querymy07 = mysql_db_query($dbname, $sqlmy07) or die("Can't Querymy07");
$rowmy07 = mysql_fetch_array($querymy07);
$overcoat_fabric_my_price_4 = $rowmy07["0"];

} else if ($rowmy7["brand"] != '') {
	
$sqlmy08 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Overcoat' ";
$querymy08 = mysql_db_query($dbname, $sqlmy08) or die("Can't Querymy08");
$rowmy08 = mysql_fetch_array($querymy08);	
$overcoat_fabric_my_price_4 = $rowmy08["0"];
	
}

$sqlmy8 = " SELECT * FROM admin_fabrics_overcoat WHERE fabricno = '$overcoat_fabric_no_5' ";
...
$sqlmy09 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Overcoat' ";
$querymy09 = mysql_db_query($dbname, $sqlmy09) or die("Can't Querymy09");
$rowmy09 = mysql_fetch_array($querymy09);
$overcoat_fabric_my_price_5 = $rowmy09["0"];

} else if ($rowmy8["brand"] != '') {
	
$sqlmy010 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Overcoat' ";
$querymy010 = mysql_db_query($dbname, $sqlmy010) or die("Can't Querymy010");
$rowmy010 = mysql_fetch_array($querymy010);	
$overcoat_fabric_my_price_5 = $rowmy010["0"];
	
}

$sqlmy9 = " SELECT * FROM admin_fabrics_overcoat WHERE fabricno = '$overcoat_fabric_no_6' ";
...
$sqlmy011 = " SELECT `fabrictypereseller_".$id_user."` FROM admin_fabrictype WHERE fabrictype_name = '$fabrics_my_type' AND fabrictype_product = 'Overcoat' ";
$querymy011 = mysql_db_query($dbname, $sqlmy011) or die("Can't Querymy011");
$rowmy011 = mysql_fetch_array($querymy011);
$overcoat_fabric_my_price_6 = $rowmy011["0"];

} else if ($row9["brand"] != '') {
	
$sqlmy012 = " SELECT `fabricbrand_".$id_user."` FROM admin_fabricbrand WHERE fabricbrand_name = '$fabrics_my_brand' AND fabricbrand_product = 'Overcoat' ";
$querymy012 = mysql_db_query($dbname, $sqlmy012) or die("Can't Querymy012");
$rowmy012 = mysql_fetch_array($querymy012);	
$overcoat_fabric_my_price_6 = $rowmy012["0"];
...
if (($overcoat_overcoat_measurement_chest >= '50' && $overcoat_overcoat_measurement_chest <= '52') || ($overcoat_overcoat_measurement_waist_only >= '50' && $overcoat_overcoat_measurement_waist_only <= '52') || ($overcoat_overcoat_measurement_hips >= '50' && $overcoat_overcoat_measurement_hips <= '52')) {
	...
	$price_my_size_4 = $overcoat_fabric_my_price_2 * 20;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $overcoat_fabric_my_price_2;
	
	$price_my_size_7 = $overcoat_fabric_my_price_3 * 20;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $overcoat_fabric_my_price_3;
	
	$price_my_size_10 = $overcoat_fabric_my_price_4 * 20;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $overcoat_fabric_my_price_4;
	
	$price_my_size_13 = $overcoat_fabric_my_price_5 * 20;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $overcoat_fabric_my_price_5;
	
	$price_my_size_16 = $overcoat_fabric_my_price_6 * 20;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $overcoat_fabric_my_price_6;
	...
	$price_my_size_4 = $overcoat_fabric_my_price_2 * 30;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $overcoat_fabric_my_price_2;
	
	$price_my_size_7 = $overcoat_fabric_my_price_3 * 30;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $overcoat_fabric_my_price_3;
	
	$price_my_size_10 = $overcoat_fabric_my_price_4 * 30;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $overcoat_fabric_my_price_4;
	
	$price_my_size_13 = $overcoat_fabric_my_price_5 * 30;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $overcoat_fabric_my_price_5;
	
	$price_my_size_16 = $overcoat_fabric_my_price_6 * 30;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $overcoat_fabric_my_price_6;
	...
	$price_my_size_4 = $overcoat_fabric_my_price_2 * 40;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $overcoat_fabric_my_price_2;
	
	$price_my_size_7 = $overcoat_fabric_my_price_3 * 40;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $overcoat_fabric_my_price_3;
	
	$price_my_size_10 = $overcoat_fabric_my_price_4 * 40;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $overcoat_fabric_my_price_4;
	
	$price_my_size_13 = $overcoat_fabric_my_price_5 * 40;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $overcoat_fabric_my_price_5;
	
	$price_my_size_16 = $overcoat_fabric_my_price_6 * 40;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $overcoat_fabric_my_price_6;
	...
	$price_my_size_4 = $overcoat_fabric_my_price_2 * 50;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $overcoat_fabric_my_price_2;
	
	$price_my_size_7 = $overcoat_fabric_my_price_3 * 50;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $overcoat_fabric_my_price_3;
	
	$price_my_size_10 = $overcoat_fabric_my_price_4 * 50;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $overcoat_fabric_my_price_4;
	
	$price_my_size_13 = $overcoat_fabric_my_price_5 * 50;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $overcoat_fabric_my_price_5;
	
	$price_my_size_16 = $overcoat_fabric_my_price_6 * 50;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $overcoat_fabric_my_price_6;
	...
	$price_my_size_4 = $overcoat_fabric_my_price_2 * 60;
	$price_my_size_5 = $price_my_size_4 / 100;
	$price_my_size_6 = $price_my_size_5 + $overcoat_fabric_my_price_2;
	
	$price_my_size_7 = $overcoat_fabric_my_price_3 * 60;
	$price_my_size_8 = $price_my_size_7 / 100;
	$price_my_size_9 = $price_my_size_8 + $overcoat_fabric_my_price_3;
	
	$price_my_size_10 = $overcoat_fabric_my_price_4 * 60;
	$price_my_size_11 = $price_my_size_10 / 100;
	$price_my_size_12 = $price_my_size_11 + $overcoat_fabric_my_price_4;
	
	$price_my_size_13 = $overcoat_fabric_my_price_5 * 60;
	$price_my_size_14 = $price_my_size_13 / 100;
	$price_my_size_15 = $price_my_size_14 + $overcoat_fabric_my_price_5;
	
	$price_my_size_16 = $overcoat_fabric_my_price_6 * 60;
	$price_my_size_17 = $price_my_size_16 / 100;
	$price_my_size_18 = $price_my_size_17 + $overcoat_fabric_my_price_6;
	...
	$price_my_size_6 = $overcoat_fabric_my_price_2;
	$price_my_size_9 = $overcoat_fabric_my_price_3;
	$price_my_size_12 = $overcoat_fabric_my_price_4;
	$price_my_size_15 = $overcoat_fabric_my_price_5;
	$price_my_size_18 = $overcoat_fabric_my_price_6;
...
$query10 = mysql_db_query($dbname, $sql10) or die("Can't Query10");
$row10 = mysql_fetch_array($query10);
$overcoat_button_my_price = $row10["price"];

$overcoat_button_my_price_1 = $price_my_size_3 + $overcoat_button_my_price;
$overcoat_button_my_price_2 = $price_my_size_6 + $overcoat_button_my_price;
$overcoat_button_my_price_3 = $price_my_size_9 + $overcoat_button_my_price;
$overcoat_button_my_price_4 = $price_my_size_12 + $overcoat_button_my_price;
$overcoat_button_my_price_5 = $price_my_size_15 + $overcoat_button_my_price;
$overcoat_button_my_price_6 = $price_my_size_18 + $overcoat_button_my_price;
...
$overcoat_my_price_2 = $overcoat_button_my_price_2 + $overcoat_sleeve_button_my_price + $overcoat_apaulettes_my_price + $overcoat_belt_loose_my_price + $overcoat_belt_sewed_my_price;

$overcoat_my_price_3 = $overcoat_button_my_price_3 + $overcoat_sleeve_button_my_price + $overcoat_apaulettes_my_price + $overcoat_belt_loose_my_price + $overcoat_belt_sewed_my_price;

$overcoat_my_price_4 = $overcoat_button_my_price_4 + $overcoat_sleeve_button_my_price + $overcoat_apaulettes_my_price + $overcoat_belt_loose_my_price + $overcoat_belt_sewed_my_price;

$overcoat_my_price_5 = $overcoat_button_my_price_5 + $overcoat_sleeve_button_my_price + $overcoat_apaulettes_my_price + $overcoat_belt_loose_my_price + $overcoat_belt_sewed_my_price;

$overcoat_price_my_6 = $overcoat_button_my_price_6 + $overcoat_sleeve_button_my_price + $overcoat_apaulettes_my_price + $overcoat_belt_loose_my_price + $overcoat_belt_sewed_my_price;
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$overcoat_order_no', '$overcoat_customer_name', '$overcoat_my_price_2', '$overcoat_price_2', '$order_product', '$overcoat_fabric_no_2', '$overcoat_date', '$overcoat_time', '$overcoat_ip', '$overcoat_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$overcoat_order_no', '$overcoat_customer_name', '$overcoat_my_price_3', '$overcoat_price_3', '$order_product', '$overcoat_fabric_no_3', '$overcoat_date', '$overcoat_time', '$overcoat_ip', '$overcoat_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$overcoat_order_no', '$overcoat_customer_name', '$overcoat_my_price_4', '$overcoat_price_4', '$order_product', '$overcoat_fabric_no_4', '$overcoat_date', '$overcoat_time', '$overcoat_ip', '$overcoat_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$overcoat_order_no', '$overcoat_customer_name', '$overcoat_my_price_5', '$overcoat_price_5', '$order_product', '$overcoat_fabric_no_5', '$overcoat_date', '$overcoat_time', '$overcoat_ip', '$overcoat_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
...
$sql14 = " INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id', '$product_id', '$company_user', '$overcoat_order_no', '$overcoat_customer_name', '$overcoat_my_price_6', '$overcoat_price_6', '$order_product', '$overcoat_fabric_no_6', '$overcoat_date', '$overcoat_time', '$overcoat_ip', '$overcoat_status') ";
$query14 = mysql_query($sql14) or die("Can't Query14");
