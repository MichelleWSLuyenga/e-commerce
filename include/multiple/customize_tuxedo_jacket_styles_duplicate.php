...
if ($tuxedo_jacket_orderid != "") {
	...
	$sql21 = " UPDATE customize_checkout SET checkout_company = '$company_user', checkout_order = '$tuxedo_jacket_order_no', checkout_date = '$tuxedo_jacket_date', checkout_time = '$tuxedo_jacket_time', checkout_ip = '$tuxedo_jacket_ip', checkout_status = '$tuxedo_jacket_status' WHERE checkout_orderid = '$order_id' ";
	$query21 = mysql_query($sql21) or die("Can't Query21");
	
} else if ($tuxedo_jacket_orderid == "") {
	
	$sql21 = " INSERT INTO customize_checkout (id, checkout_company, checkout_order, checkout_orderid, checkout_date, checkout_time, checkout_ip, checkout_status) VALUES ('$id_customize_checkout', '$company_user', '$tuxedo_jacket_order_no', '$order_id', '$tuxedo_jacket_date', '$tuxedo_jacket_time', '$tuxedo_jacket_ip', '$tuxedo_jacket_status') ";
	$query21 = mysql_query($sql21) or die("Can't Query21");
