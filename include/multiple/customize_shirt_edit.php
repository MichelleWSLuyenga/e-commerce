...
$sql3 =	" UPDATE customize_order SET order_reseller = '$company_user', order_order_no = '$shirt_order_no', order_name_customize = '$shirt_customer_name', order_my_price = '$shirt_my_price_1', order_price = '$shirt_price_1', order_product = '$order_product', order_fabric_no = '$shirt_fabric_no_1', order_date = '$shirt_date', order_time = '$shirt_time', order_ip = '$shirt_ip', order_status = '$shirt_status' WHERE order_id = '$order_id' AND product_id = '$product_id' ";
