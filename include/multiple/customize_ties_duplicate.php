...
$sql7 =	" INSERT INTO customize_order (id, order_id, product_id, order_reseller, order_order_no, order_name_customize, order_my_price, order_price, order_product, order_fabric_no, order_date, order_time, order_ip, order_status) VALUES ('$id_order', '$order_id_same', '$product_id', '$company_user', '$ties_order_no', '$ties_customer_name', '$order_my_price', '$order_price', '$order_product', '$ties_fabric_no', '$ties_date', '$ties_time', '$ties_ip', '$ties_status') ";
$query7 = mysql_query($sql7) or die("Can't Query7");

$sql8 = " INSERT INTO customize_ties_design (id, order_id, product_id, ties_customer_name, ties_order_no, ties_fabric_no, ties_date, ties_time, ties_ip, ties_status)  VALUES ('$id_ties', '$order_id_same', '$product_id', '$ties_customer_name', '$ties_order_no', '$ties_fabric_no', '$ties_date', '$ties_time', '$ties_ip', '$ties_status') ";
