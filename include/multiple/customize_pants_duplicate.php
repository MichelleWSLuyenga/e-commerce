...
/*BUTTON*/
$pants_pants_back_button = $row1["pants_pants_back_button"];
...
$pants_fly_option_zip = $row1["pants_fly_option_zip"];
...
$pants_internal_waistband_color = $row1["pants_internal_waistband_color"];
