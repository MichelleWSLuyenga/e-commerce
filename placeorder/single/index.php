...
<script language="javascript" type="text/javascript">
  function checkSend() {
    if (confirm('Are you sure want to send order?')==true) {
      return true;
    } else {
        return false;
    }
...
<div class="row">
<div class="row show-grid">
<form name="frmMain" action="../../include/single/placeorder.php" method="post" OnSubmit="return checkSend()">
<table class="table table-bordered table-striped mb-none" id="datatable-default">
  ...
  <tbody>
    ...
    <tr class="gradeX">
      ...
      <td><a href="../../cart/single/index.php?orderid=<?=$objResult['checkout_orderid'];?>">
