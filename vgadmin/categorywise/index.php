          ...
          <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
              ...
              <div id="printable"><br>
                ...
                <? 
	  				$strSQL1 = " SELECT * FROM customize_checkout WHERE checkout_number != '0' AND checkout_status = 'T' AND checkout_status_send = 'send' ";
				...
				?>
                    ...
                    <tr style="height:50px;">
                      ...
                      <td width="5%" style="border: 1px solid #c5c5c5; font-weight:100;" align="center"><?
