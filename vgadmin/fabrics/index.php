      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabrics_add_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_jacket" id="fabrics_jacket" value="jacket">
                      Jacket <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_jeans" id="fabrics_jeans" value="jeans">
                      Jeans <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_overcoat" id="fabrics_overcoat" value="overcoat">
                      Overcoat <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_pants" id="fabrics_pants" value="pants">
                      Pants <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_shirt" id="fabrics_shirt" value="shirt">
                      Shirt <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_suits" id="fabrics_suits" value="suits">
                      Suits <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="fabrics_vest" id="fabrics_vest" value="vest">
			  ...
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrics_type" id="fabrics_type">
                      <option style="font-family: 'Roboto', sans-serif;" value="">--Select Fabric Type--</option>
			  ...
			  ?>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrics_number" id="fabrics_number" placeholder="Fabric Number" required>
                  </div>
                   <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Supplier Number </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="supplier_number" id="supplier_number" placeholder="Supplier Number" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Fabric Color </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrics_color" id="fabrics_color" placeholder="Fabric Color">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Fabric Pattern </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrics_pattern" id="fabrics_pattern" placeholder="Fabric Pattern">
                  </div>
                  <div class="form-group m-form__group">
