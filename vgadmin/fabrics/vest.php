      ...
      <div class="m-content">
        <div class="row">
                ...
                <div class="m-portlet__head-caption" align="center">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text" style="text-transform:uppercase;" style="font-family: 'Roboto', sans-serif;">
                                            <?
                                                    $strSQL = " SELECT * FROM admin_fabrics_vest ";
                                                    $objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
                                                    $Num_Rows = mysql_num_rows($objQuery);
                                                    $Per_Page = 120;
                                              ?>
                    <strong> Vest Fabrics  Total(<?php echo $Num_Rows;?> )</strong>
                    </h3>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body">
                <div align="right">
                  <form class="m-form m-form--fit m-form--label-align-right" action="vest_search.php" method="post">
                    <label style="font-family: 'Roboto', sans-serif;">
                      <input type="text" class="form-control m-input" name="fabrics_number" id="fabrics_number" placeholder="Fabric/Supplier Number" required>
                    </label>
                    <label style="font-family: 'Roboto', sans-serif;">
                ...
                <br>
                <!--begin: Datatable -->
                <form name="frmMain" action="delete_vest.php" method="post" OnSubmit="return checkDelete()">
                  <table class="table table-striped- table-bordered table-hover table-checkable">
                    <!-- <button type="submit" class="btn btn-danger" style="margin-bottom: 10px">Delete</button> -->
                    <button type="submit" class="btn btn-danger" style="font-family: 'Roboto', sans-serif;"> Update Status </button>
                      <button style="margin: 5px;" class="btn btn-danger btn-xs delete-all">Delete </button>
                      <input type="hidden" name="decision"> 
                    <thead>
                      <tr>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> <input type="checkbox" id="check_all"></th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Type </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Supplier No </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Fabric No </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Color </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Pattern </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Status </th>
          ...
          ?>
                      ...
                      <tr>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><input type="checkbox" class="checkbox" name="chkDel[]" value="<?php echo $objResult['id'];?>"></td>
                        <!--Here-->
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["type"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["supplierno"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["fabricno"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["color"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["pattern"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><? if($objResult["fabrics_status"] == 'T') { ?>
                          AVAILABLE
                          <? } else if($objResult["fabrics_status"] == 'F') { ?>
                          OUT OF STOCK
                          <? } ?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?id=<?=$objResult["id"]?>&&fabrics_product=vest"> Edit </a></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="update.php?id=<?=$objResult["id"]?>&&fabrics_product=vest&&fabrics_status=<?=$objResult["fabrics_status"]?>"> Change Stock </a></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  </table>
                </form>
                <div align="right" style="font-size:14px; color:#000000; letter-spacing:1px;">
