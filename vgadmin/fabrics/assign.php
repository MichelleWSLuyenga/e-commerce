                  ...
                  <div class="form-group m-form__group">
                    ...
                    <?
                      $strSQL1 = " SELECT * FROM admin_category WHERE category_status = 'T' ORDER BY category_name ASC ";
			              ...
			              ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabricstb_category" id="fabricstb_category">
											...
											<div style="font-family: 'Roboto', sans-serif;" class="">
												<? while($objResult3 = mysql_fetch_array($objQuery3)) { ?>
													<label class="m-checkbox"><?=$objResult3["fabrictype_name"]?>
														<input type="checkbox" name="checkMe" class="checkMe" style="font-family: 'Roboto', sans-serif;" value="<?php echo $objResult3['id'];?>"><span></span>
													</label>  &nbsp;&nbsp;
												<? } ?>
											</div>
										</div>
												...
												<div style="font-family: 'Roboto', sans-serif;" class="">
													<? while($objResult1 = mysql_fetch_array($objQuery1)) { ?>
														<label class="m-checkbox"><?=$objResult1["fabricbrand_name"]?>
															<input type="checkbox" name="checkMe" class="checkMe" style="font-family: 'Roboto', sans-serif;" value="<?php echo $objResult1['id'];?>"><span></span>
														</label>  &nbsp;&nbsp;
													<? } ?>
												</div>
											</div>
