                ...
                <div class="m-portlet__head-caption" align="center">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text" style="text-transform:uppercase;" style="font-family: 'Roboto', sans-serif;">
                                            <?
                                                $strSQL = " SELECT * FROM admin_fabrics_overcoat ";
                                                $objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
                                                $Num_Rows = mysql_num_rows($objQuery);
                                            ?>
                    <strong> Overcoat Fabrics (<?php echo $Num_Rows;?> )</strong>
                    </h3>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body">
                ...
                <br>
                <!--begin: Datatable -->
                <form name="frmMain" action="delete_overcoat.php" method="post" OnSubmit="return checkDelete()">
	  			...
	  			?>
                      ...
                      <tr>
                        ...
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><? if($objResult["fabrics_status"] == 'T') { ?>
                          ...
                          OUT OF STOCK
                          <? } ?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?id=<?=$objResult["id"]?>&&fabrics_product=overcoat"> Edit </a></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="update.php?id=<?=$objResult["id"]?>&&fabrics_product=overcoat&&fabrics_status=<?=$objResult["fabrics_status"]?>"> Change Stock </a></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  </table>
