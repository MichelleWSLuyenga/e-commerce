      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabrictype_add_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
										<label style="font-family: 'Roboto', sans-serif;">Select Category</label>
										<input type="hidden" name="fabrictype_admin" id="fabrictype_admin" value="<?=$row_user['id'];?>" required>
                    <?
              $strSQL1 = " SELECT * FROM admin_category WHERE category_status = 'T' ORDER BY category_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrictype_category" id="fabrictype_category">
                    ...
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> Show all category created by admin </span>
								...
								<div class="form-group m-form__group">
									<label style="font-family: 'Roboto', sans-serif;"> Select Fabrictype </label>
									<input type="hidden" name="fabrictype_admin" id="fabrictype_admin" value="<?=$row_user['id'];?>" required>
									<label class="m-checkbox">
										<input type="checkbox" style="font-family: 'Roboto', sans-serif;" class="form-control m-input" name="type1">
										Type 1  </label>
									<label class="m-checkbox">
										<input type="checkbox" style="font-family: 'Roboto', sans-serif;" class="form-control m-input" name="type2">
										Type 2  </label>
									<label class="m-checkbox">
										<input type="checkbox" style="font-family: 'Roboto', sans-serif;" class="form-control m-input" name="type3">
										Type 3  </label>
									<label class="m-checkbox">
										<input type="checkbox" style="font-family: 'Roboto', sans-serif;" class="form-control m-input" name="type4">
										Type 4  </label>
									<label class="m-checkbox">
										<input type="checkbox" style="font-family: 'Roboto', sans-serif;" class="form-control m-input" name="type5">
										Type 5  </label>
									<label class="m-checkbox">
										<input type="checkbox" style="font-family: 'Roboto', sans-serif;" class="form-control m-input" name="type6">
										Type 6  </label>
								</div>
								<div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Select Fabrictype </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrictype_name" id="fabrictype_name" placeholder="Fabric Type Name" required>
                    <!-- <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> For Example Type 1 </span> </div> -->
                </div>
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body">
            <!--begin: Datatable -->
            <?
              $strSQL1 = " SELECT DISTINCT(fabrictype_name), fabrictype_id FROM admin_fabrictype WHERE fabrictype_status = 'T' ORDER BY fabrictype_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable">
              ...
              <thead>
                <tr>
                  ...
                  <th style="font-family: 'Roboto', sans-serif;"> Fabric Type Name </th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["fabrictype_name"]?></td>
									<td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["fabrictype_category"]?></td>
                  <td style="font-family: 'Roboto', sans-serif;"><a href="edit.php?fabrictype_id=<?=$objResult1["fabrictype_id"]?>"> Edit </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
