...
<?	
	...
	$fabrictype_id = $_GET["fabrictype_id"];
	
	$sql1 =	" SELECT * FROM admin_fabrictype WHERE fabrictype_id = '$fabrictype_id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabrictype_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Fabric Type Name </label>
                    ...
                    <input type="hidden" name="fabrictype_id" id="fabrictype_id" value="<?=$row1['fabrictype_id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabrictype_name" id="fabrictype_name" value="<?=$row1['fabrictype_name'];?>" placeholder="Fabric Type Name" required>
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable">
                ...
                <thead>
                  <tr>
                    ...
                    <!-- <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><input type="checkbox" name="checkall" id="checkall" onClick="check_uncheck_checkbox(this.checked);" /></th> -->
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Fabric Type Name </th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <!--Here-->
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["fabrictype_name"]?></td>
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?fabrictype_id=<?=$objResult1["fabrictype_id"]?>"> Edit </a></td>
                  </tr>
                  <? } ?>
                </tbody>
              </table>
