...
<?
	...
	$sql1 =	" SELECT * FROM admin_design WHERE design_type = 'Overcoat' AND design_option_sql = '$design_option_sql' AND design_status = 'T' ";
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper"> 
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div align="right">
              <label style="font-family: 'Roboto', sans-serif;"> <a href="add_option_overcoat.php?design_type=<?=$row1['design_type'];?>&&design_option_name=<?=$row1['design_option_name'];?>&&design_option_sql=<?=$row1['design_option_sql'];?>">
            ...
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body"> 
                <!--begin: Datatable -->
                <?
              $strSQL1 = " SELECT * FROM admin_design_option WHERE design_type = 'Overcoat' AND design_option_sql = '$design_option_sql' AND design_status = 'T' ORDER BY id ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
                <form name="frmMain" action="delete_option_overcoat.php" method="post" OnSubmit="return checkDelete()">
                  <table class="table table-striped- table-bordered table-hover table-checkable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit_option_overcoat.php?id=<?=$objResult1["id"]?>"> Edit </a></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  </table>
