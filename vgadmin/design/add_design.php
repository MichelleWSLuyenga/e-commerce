              ...
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/design_add_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_option_name" id="design_option_name" placeholder="Design Option Name" required>
                  </div>
                </div>
