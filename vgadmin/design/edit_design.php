...
<?	
	...
	$sql1 =	" SELECT * FROM admin_design WHERE id = '$id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/design_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <input type="hidden" name="id" id="id" value="<?=$row1['id'];?>" required>
                    <input type="hidden" name="id_design" id="id_design" value="<?=$id_design?>" required>
                    <input type="hidden" name="design_admin" id="design_admin" value="<?=$row_user['id'];?>" required>
                    <input type="hidden" name="design_type" id="design_type" value="<?=$design?>" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Design Option Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_option_name" id="design_option_name" placeholder="Design Option Name" value="<?=$row1['design_option_name'];?>" required>
                  </div>
                </div>
