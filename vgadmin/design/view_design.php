    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper"> 
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div align="right">
              <label style="font-family: 'Roboto', sans-serif;"> <a href="add_design.php?id_design=<?=$id?>&&design=<?=$row1["category_name"]?>">
                <button type="button" class="btn btn-primary" style="font-family: 'Roboto', sans-serif;"> Add more options </button>
                </a> </label>
            </div>
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body"> 
                <!--begin: Datatable -->
                <?
				$design = $row1["category_name"];
                $strSQL1 = " SELECT * FROM admin_design WHERE design_type = '$design' AND design_status = 'T' ORDER BY id ASC ";
			    $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			    ?>
                <form name="frmMain" action="delete_design.php" method="post" OnSubmit="return onDelete();">
                  <table class="table table-striped- table-bordered table-hover table-checkable">
                    <thead>
                      <tr>
                        ...
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Design Name </th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><input type="checkbox" name="chkDel[]" value="<?php echo $objResult1['id'];?>">
                          <input type="hidden" name="design" name="design" value="<?=$design?>">
                          <input type="hidden" name="id_design" name="id_design" value="<?=$id?>"></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["design_option_name"]?>
                          <?
                      $sql1 =	" SELECT COUNT(id) FROM admin_design_option WHERE design_type = '$design' AND design_option_sql = '".$objResult1["design_option_sql"]."' AND design_status = 'T' ";
					  ...
					  ?>
                        ...
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit_design.php?id_design=<?=$id?>&&design=<?=$design?>&&id=<?=$objResult1["id"]?>"> Edit </a></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="view_option_design.php?design=<?=$design?>&&design_option_sql=<?=$objResult1["design_option_sql"]?>"> Add Option </a></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  </table>
