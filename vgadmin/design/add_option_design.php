...
<?	
	...
	$design_option_name = $_GET["design_option_name"];
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/option_design_add_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="hidden" name="design" id="design" value="<?=$design?>" required>
                    <input type="hidden" name="design_type" id="design_type" value="<?=$design_type?>" required>
                    <input type="hidden" name="design_option_sql" id="design_option_sql" value="<?=$design_option_sql?>" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Design Option Name </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_option_name" id="design_option_name" value="<?=$design_option_name?>" placeholder="Design Option Name" readonly>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Design Sub-Option Name (EN) </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_sub_option_name_en" id="design_sub_option_name_en" placeholder="Design Sub-Option Name (EN)" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Design Sub-Option Name (TH) </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_sub_option_name_th" id="design_sub_option_name_th" placeholder="Design Sub-Option Name (TH)">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Design Sub-Option Value </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_sub_option_value" id="design_sub_option_value" placeholder="Design Sub-Option Value" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;" for="exampleInputEmail1"> Design Sub-Option Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" style="font-family: 'Roboto', sans-serif;" name="design_image" id="design_image">
