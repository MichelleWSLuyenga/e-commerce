      ...
      <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body"> 
            <!--begin: Datatable -->
            <?
              $strSQL1 = " SELECT * FROM admin_category WHERE category_status = 'T' AND category_name != 'Ties' ORDER BY category_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
            <table class="table table-striped- table-bordered table-hover table-checkable">
              <thead>
                <tr>
                  <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Design Type Name </th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="view_design.php?id=<?=$objResult1["id"]?>"> View </a></td>
                </tr>
                <? } ?>
              </tbody>
            </table>
