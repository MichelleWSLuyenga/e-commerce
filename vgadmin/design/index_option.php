      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/design_add_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_type" id="design_type">
                      <option style="font-family: 'Roboto', sans-serif;" value="Jacket"> Jacket </option>
                      <option style="font-family: 'Roboto', sans-serif;" value="Jeans"> Jeans </option>
                      <option style="font-family: 'Roboto', sans-serif;" value="Overcoat"> Overcoat </option>
                      <option style="font-family: 'Roboto', sans-serif;" value="Pants"> Pants </option>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="design_option" id="design_option" placeholder="Option Name" required>
                  </div>
