          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--mobile">
              <div class="m-portlet__body"> 
                <!--begin: Datatable -->
                <?
              $strSQL1 = " SELECT * FROM admin_design WHERE design_type = 'Shirt' AND design_status = 'T' ORDER BY id ASC ";
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["design_option_name"]?>
                        <?
                      $sql1 =	" SELECT COUNT(id) FROM admin_design_option WHERE design_type = 'Shirt' AND design_option_sql = '".$objResult1["design_option_sql"]."' AND design_status = 'T' ";
                      ...
                      <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="view_option_shirt.php?design_option_sql=<?=$objResult1["design_option_sql"]?>"> View </a></td>
                    </tr>
                    <? } ?>
                  </tbody>
                </table>
