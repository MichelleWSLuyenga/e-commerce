...
<?	
	...
	$sql1 =	" SELECT * FROM admin_category WHERE id = '$id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/category_edit_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Category Name </label>
                    <input type="hidden" name="id" id="id" value="<?=$row1['id'];?>" required>
                    <input type="hidden" name="category_admin" id="category_admin" value="<?=$row_user['id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="category_name" id="category_name" value="<?=$row1['category_name'];?>" placeholder="Category Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Category Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" name="category_image" id="category_image" placeholder="Category Image" required>
                    </div>
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif; color:#F00;"> Width: 500 * Height: 700 Only </span>
                    <? if($row1['category_image'] != "") { ?>
                    <div class="form-group m-form__group"> <img class="img-responsive" src="../../images/category/<?=$row1['category_image'];?>?v=1001" width="150" height="200"> </div>
                    <? } if($row1['category_image'] == "") { } ?>
                  </div>
                </div>
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable">
                <thead>
                  <tr>
                    ...
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Category Name </th>
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Category Image </th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><input type="checkbox" name="chkDel[]" value="<?php echo $objResult1['id'];?>"></td>
                    <!--Here-->
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["category_name"]?></td>
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><img class="img-responsive" src="../../images/category/<?=$objResult1['category_image'];?>?v=1001" width="150" height="200"></td>
