              ...
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption" align="center">
                  <div class="m-portlet__head-title">
                    ...
                    <strong> Overcoat Buttons </strong>
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <form name="frmMain" action="delete_overcoat.php" method="post" OnSubmit="return checkDelete()">
                  <table class="table table-striped- table-bordered table-hover table-checkable">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Button No </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Type </th>
                        <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Description </th>
                    ...
                    <tbody>
                      <?
	  				$strSQL = " SELECT * FROM admin_buttons_overcoat ";
	  			...
	  			?>
                      ...
                      <tr>
                        ...
                        <!--Here-->
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["buttonno"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["type"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult["description"]?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><? if($objResult["buttons_status"] == 'T') { ?>
                          AVAILABLE
                          <? } else if($objResult["buttons_status"] == 'F') { ?>
                          OUT OF STOCK
                          <? } ?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?id=<?=$objResult["id"]?>&&buttons_product=overcoat"> Edit </a></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="update.php?id=<?=$objResult["id"]?>&&buttons_product=overcoat&&buttons_status=<?=$objResult["buttons_status"]?>"> Change Stock </a></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  </table>
