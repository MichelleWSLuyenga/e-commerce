              ...
              <div class="m-portlet__body"> 
                ...
                <form name="frmMain" action="delete_vest.php" method="post" OnSubmit="return checkDelete()">
                  <table class="table table-striped- table-bordered table-hover table-checkable">
                    ...
                    <tbody>
                      <?
	  				$strSQL = " SELECT * FROM admin_buttons_vest ";
	  			...
	  			?>
                      ...
                      <tr>
                        ...
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><? if($objResult["buttons_status"] == 'T') { ?>
                          ...
                          OUT OF STOCK
                          <? } ?></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?id=<?=$objResult["id"]?>&&buttons_product=vest"> Edit </a></td>
                        <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="update.php?id=<?=$objResult["id"]?>&&buttons_product=vest&&buttons_status=<?=$objResult["buttons_status"]?>"> Change Stock </a></td>
                      </tr>
                      <? } ?>
                    </tbody>
                  </table>
