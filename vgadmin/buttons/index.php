      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/buttons_add_code.php" method="post" enctype="multipart/form-data" name="frmMain">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="buttons_jacket" id="buttons_jacket" value="jacket">
                      Jacket <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="buttons_overcoat" id="buttons_overcoat" value="overcoat">
                      Overcoat <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="buttons_pants" id="buttons_pants" value="pants">
                      Pants <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="buttons_shirt" id="buttons_shirt" value="shirt">
                      Shirt <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="buttons_suits" id="fabrics_suits" value="suits">
                      Suits <span></span> </label>
                    &nbsp;&nbsp;
                    <label class="m-checkbox">
                      <input type="checkbox" style="font-family: 'Roboto', sans-serif;" name="buttons_vest" id="buttons_vest" value="vest">
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <select class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="buttons_type" id="buttons_type">
                      <option style="font-family: 'Roboto', sans-serif;" value="">--Select Buttons Type--</option>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="buttons_buttonno" id="buttons_buttonno" placeholder="Buttons Number" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Buttons Description </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="buttons_description" id="buttons_description" placeholder="Buttons Description">
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;" for="exampleInputEmail1"> Image </label>
                    <div></div>
                    <div class="custom-file">
                      <input type="file" style="font-family: 'Roboto', sans-serif;" name="buttons_image" id="buttons_image">
