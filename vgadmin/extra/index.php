...
<script>
	...
	num.addEventListener("keypress", function onEvent(event) {
		if (event.key === "Enter") {
			  ...
			  ?>
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <label style="font-family: 'Roboto', sans-serif;"> Option Name </label>
										...
										<!-- Dynamic adding box -->
                    <input type="number" name="amount" id="amount" class="form-control m-input" style="font-family: 'Roboto', 'sans-serif';" placeholder="Enter amount" onkeypress="return onEvent()" required><br>
