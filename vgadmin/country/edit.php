...
<?	
	...
	$sql1 =	" SELECT * FROM admin_country WHERE id = '$id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/country_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="country_name" id="country_name" value="<?=$row1['country_name'];?>" placeholder="Country Name" required>
                  </div>
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Currency </label>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="country_currency" id="country_currency" value="<?=$row1['country_currency'];?>" placeholder="Currency" required>
                  </div>
                </div>
          ...
          <div class="m-portlet__body"> 
            ...
            <form name="frmMain" action="delete.php" method="post" OnSubmit="return onDelete();">
              <table class="table table-striped- table-bordered table-hover table-checkable">
                <thead>
                  <tr>
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Country Name </th>
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> </th>
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> <button type="submit" class="btn btn-primary" style="font-family: 'Roboto', sans-serif;"> Delete </button>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["country_name"]?></td>
