              ...
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/country_add_code.php" method="post">
                <div class="m-portlet__body">
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="country_currency" id="country_currency" placeholder="Currency" required>
                  </div>
                </div>
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable">
                <thead>
                  <tr>
                    ...
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Country Currency </th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["country_currency"]?></td>
