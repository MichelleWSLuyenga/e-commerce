    ...
    <div id="m_aside_left" class="m-grid__item m-aside-left m-aside-left--skin-dark">
      <!-- BEGIN: Aside Menu -->
        ...
        <ul class="m-menu__nav m-menu__nav--dropdown-submenu-arrow">
          ...
          <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"> <a  href="../orders/" class="m-menu__link m-menu__toggle"> <span class="m-menu__link-text" style="font-family: 'Roboto', sans-serif;"> Orders </span> </a>
						<div class="m-menu__submenu "> <span class="m-menu__arrow"></span>
							<ul class="m-menu__subnav">
								<!-- Added for create order options -->
								<li class="m-menu__item  m-menu__item--parent" aria-haspopup="true"> <span class="m-menu__link"> <span class="m-menu__link-text" style="font-family: 'Roboto', sans-serif;"> Create Order Options </span> </span> </li>
								<li class="m-menu__item " aria-haspopup="true"> <a  href="../orders/addcat.php" class="m-menu__link "> <i class="m-menu__link-bullet m-menu__link-bullet--dot"> <span></span> </i> <span class="m-menu__link-text" style="font-family: 'Roboto', sans-serif;"> Create Order Options </span> </a> </li>
							</ul>
						</div></li>
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab">
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/country_add_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Country Name </label>
                    <input type="hidden" name="country_admin" id="country_admin" value="<?=$row_user['id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="country_name" id="country_name" placeholder="Country Name" required>
                  </div>
                </div>
        ...
        <div class="m-portlet m-portlet--mobile">
          <div class="m-portlet__body">
            <!--begin: Datatable -->
            <?
              $strSQL1 = " SELECT * FROM admin_country WHERE country_status = 'T' ORDER BY country_name ASC ";
			  $objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL1."]");
			  ?>
					<form name="frmMain" action="delete.php" method="post" OnSubmit="return checkDelete()">
						<!--Add the options filter for the selected box here above don't forget to make it responsive to db-->
            <table class="table table-striped- table-bordered table-hover table-checkable">
              <!--Add check-list so can add, delete, or update. Make a filter options-->
              <!--2.Every delete button must show notification: Are you sure want to delete? Can do by js pop-up-->
              <button type="submit" class="btn btn-danger" style="margin-bottom: 10px">Delete</button>
              <thead>
                <tr><!--th for multiple check-box at once-->
                  ...
                  <th style="font-family: 'Roboto', sans-serif;"> Country Name </th>
                  <th style="font-family: 'Roboto', sans-serif;"> </th>
                </tr>
              </thead>
              <tbody><!--Changed from "while($objResult1 = mysql_fetch_array($objQuery1)) { ?>"-->
                <? while($objResult1 = mysql_fetch_array($objQuery1)) { ?>
                <tr><!--Checkbox should automatically come up according to the countries db rethrieve-->
                  <!-- What sql&php work? -->
									<td style="font-family: 'Roboto', sans-serif;"><input type="checkbox" name="checkme" class="checkSingle" value="<?php echo $objResult1['id'];?>"></td><!--Here-->
                  <td style="font-family: 'Roboto', sans-serif;"><?=$objResult1["country_name"]?></td>
