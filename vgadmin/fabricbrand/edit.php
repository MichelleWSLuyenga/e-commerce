...
<?	
	...
	$fabricbrand_id = $_GET["fabricbrand_id"];
	
	$sql1 =	" SELECT * FROM admin_fabricbrand WHERE fabricbrand_id = '$fabricbrand_id' ";
      ...
      <div class="m-content">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="m-portlet m-portlet--tab"> 
              <!--begin::Form-->
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabricbrand_edit_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    <label style="font-family: 'Roboto', sans-serif;"> Brand Type Name </label>
                    ...
                    <input type="hidden" name="fabricbrand_id" id="fabricbrand_id" value="<?=$row1['fabricbrand_id'];?>" required>
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabricbrand_name" id="fabricbrand_name" value="<?=$row1['fabricbrand_name'];?>" placeholder="Brand Type Name" required>
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable">
                <thead>
                  <tr>
                    ...
                    <th style="font-family: 'Roboto', sans-serif; vertical-align:middle;"> Brand Name </th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <!--Here-->
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><?=$objResult1["fabricbrand_name"]?></td>
                    <td style="font-family: 'Roboto', sans-serif; vertical-align:middle;"><a href="edit.php?fabricbrand_id=<?=$objResult1["fabricbrand_id"]?>"> Edit </a></td>
                  </tr>
                  <? } ?>
                </tbody>
              </table>
