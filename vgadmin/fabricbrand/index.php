              ...
              <form class="m-form m-form--fit m-form--label-align-right" action="../include/fabricbrand_add_code.php" method="post">
                <div class="m-portlet__body">
                  <div class="form-group m-form__group">
                    ...
                    <input type="text" class="form-control m-input" style="font-family: 'Roboto', sans-serif;" name="fabricbrand_name" id="fabricbrand_name" placeholder="Brand Type Name" required>
                    <span class="m-form__help" style="font-family: 'Roboto', sans-serif;"> For Example Brand 1 </span> </div>
                </div>
