...
function JacketWristLeft()
{
  ...
  var m2 = document.getElementById('shirt_measurement_wrist_left');
  var m3 = document.getElementById('overcoat_overcoat_measurement_wrist_left');
  m2.value = m1.value;
  m3.value = m1.value;
}
</script>
...
<script>
function PantsOnlyCrotch()
{
  var m1 = document.getElementById('pants_pants_measurement_only_crotch');
  var m2 = document.getElementById('jeans_measurement_crotch');
  m2.value = m1.value;
}
</script>
<style type="text/css">
