            ...
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <div class="panel">
                    ...
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Select Measurement </div>
                    <select class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" name="jacket_jacket_tailor_allowance" id="jacket_jacket_tailor_allowance">
                  ...
                  <div class="col-md-12" align="left" id="jacket_fit">
             ...
             <div class="col-md-6" align="left">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Upper Waist<font style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"></font> </div>
                    <div class="input-group input-group-icon">
                
                      <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="jacket_jacket_measurement_upper_wrist" id="jacket_jacket_measurement_upper_wrist" maxlength="10" OnKeyPress="return chkNumber(this)">
                      <span class="input-group-addon"> <span class="icon">inch</span> </span> </div>
                    <br>
                  </div>

                  <div class="col-md-6" align="left">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Lower Waist<font style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:14px; letter-spacing:1px;"></font> </div>
                    <div class="input-group input-group-icon">
                      <input class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" type="text" name="jacket_jacket_measurement_lower_wrist" id="jacket_jacket_measurement_lower_wrist" maxlength="10" OnKeyPress="return chkNumber(this)">
                      <span class="input-group-addon"> <span class="icon">inch</span> </span> </div>
                    <br>
                  </div>
                ...
                <div class="col-md-12" align="left">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Select Measurement </div>
                    <select class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" name="pants_pants_tailor_allowance" id="pants_pants_tailor_allowance">
                     <option value="Body Measurement">Body Measurement</option>
                      <option value="Final Measurement">Final Measurement</option>>
                    </select>
                    <br>
                  ...
                  <div class="col-md-6" align="left" id="pant_fit">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Fit </div>
                ...
                <div class="col-md-12" align="left">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Select Measurement </div>
                    <select class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" name="vest_vest_tailor_allowance" id="vest_vest_tailor_allowance">
                     <option value="Body Measurement">Body Measurement</option>
                      <option value="Final Measurement">Final Measurement</option>>
                    </select>
                    <br>
                  ...
                  <div class="col-md-12" align="left" id="vest_fit">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Fit </div>
                ...
                <div class="panel">
                    <div class="col-md-12" align="left">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Select Measurement </div>
                    <select class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" name="shirt_shirt_tailor_allowance" id="shirt_shirt_tailor_allowance">
                     <option value="Body Measurement">Body Measurement</option>
                      <option value="Final Measurement">Final Measurement</option>>
                    </select>
                    <br>
                  ...
                  <div class="col-md-6" align="left" id="shirt_fit">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Fit </div>
                ...
                <div class="panel">
                   <div class="col-md-12" align="left">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Select Measurement </div>
                    <select class="form-control" style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px; width:200px;" name="overcoat_overcoat_tailor_allowance" id="overcoat_overcoat_tailor_allowance">
                     <option value="Body Measurement">Body Measurement</option>
                      <option value="Final Measurement">Final Measurement</option>>
                    </select>
                    <br>
                  </div>
                  <div class="col-md-12" align="left" id="overcoat_fit">
                    <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> Fit </div>
              ...
              <div class="col-md-6">
                ...
                <div class="accordion">
                  <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:14px; letter-spacing:1px;"> <i class="fa fa-caret-right"></i> <strong> WAIST PANT </strong> </div>
                  <hr>
                </div>
                <div class="panel">
                  <div class="col-md-3" align="center">
...
$(function() {
    //$('#row_dim').hide(); 
    $('#jacket_jacket_tailor_allowance').change(function(){
     // alert(1)
        if($('#jacket_jacket_tailor_allowance').val() == 'Final Measurement') {
           $('#jacket_fit').hide(); 
        } else {
            $('#jacket_fit').show(); 
        } 
...
$(function() {
    //$('#row_dim').hide(); 
    $('#pants_pants_tailor_allowance').change(function(){
     // alert(1)
        if($('#pants_pants_tailor_allowance').val() == 'Final Measurement') {
           $('#pant_fit').hide(); 
        } else {
            $('#pant_fit').show(); 
        } 
...
$(function() {
    //$('#row_dim').hide(); 
    $('#vest_vest_tailor_allowance').change(function(){
     // alert(1)
        if($('#vest_vest_tailor_allowance').val() == 'Final Measurement') {
           $('#vest_fit').hide(); 
        } else {
            $('#vest_fit').show(); 
        } 
...
$(function() {
    //$('#row_dim').hide(); 
    $('#shirt_shirt_tailor_allowance').change(function(){
     // alert(1)
        if($('#shirt_shirt_tailor_allowance').val() == 'Final Measurement') {
           $('#shirt_fit').hide(); 
        } else {
            $('#shirt_fit').show(); 
        } 
...
$(function() {
    //$('#row_dim').hide(); 
    $('#overcoat_overcoat_tailor_allowance').change(function(){
     // alert(1)
        if($('#overcoat_overcoat_tailor_allowance').val() == 'Final Measurement') {
           $('#overcoat_fit').hide(); 
        } else {
            $('#overcoat_fit').show(); 
        } 
