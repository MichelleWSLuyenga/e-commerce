      ...
      <div class="row">
        <div class="row show-grid">
          <table class="table table-bordered table-striped mb-none" id="datatable-default">
            <thead>
              <tr>
                <th> <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;" align="center"> Invoice No </div>
                </th>
                ...
                <th> <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;" align="center"> Invoice (Order No) </div>
                <th> <div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;" align="center"> Invoice (Day) </div>
            ...
            <tbody>
              ...
              $strSQL = " SELECT * FROM customize_checkout WHERE checkout_company = '$reseller_company' AND checkout_status = 'T' ORDER BY id DESC "; 
              ...
              <tr class="gradeX">
				...
				?>
                <td align="center"><a href="../../pdf/order_invoice_day.php?order_date=<?=$checkout_date?>&&order_reseller=<?=$reseller?>" target="_blank">
                  <div style="font-family: 'Roboto', sans-serif; color:#FF0000; font-size:10px; letter-spacing:1px;"> Download </div>
                  </a></td>
                <td><div style="font-family: 'Roboto', sans-serif; color:#000000; font-size:10px; letter-spacing:1px;">
